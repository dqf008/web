...
switch(false){
    ...
    default:
        ...
        $lotteryNames =array('cqkl10'=>'重庆快乐10分','tjkl10'=>'天津快乐10分','hnkl10'=>'湖南快乐10分','sxkl10'=>'山西快乐10分','ynkl10'=>'云南快乐10分','ffkl10'=>'分分快乐10分','sfkl10'=>'三分快乐10分');
        $gameType =array('cqkl10'=>'CQKLSF','tjkl10'=>'TJKLSF','hnkl10'=>'HNKLSF','sxkl10'=>'SXKLSF','ynkl10'=>'YNKLSF','ffkl10'=>'FFKLSF','sfkl10'=>'SFKLSF');
        $params = array(':kaipan' => date('H:i:s', $LOT['bjtime']), ':fengpan' => date('H:i:s', $LOT['bjtime']));
        $sql = "SELECT `qishu` FROM `c_opentime_klsf` WHERE `kaipan`<=:kaipan AND `fengpan`>=:fengpan and `name`='$lotteryType' ORDER BY `fengpan` ASC";
