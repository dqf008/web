...
$LOT['output']['Obj']['CurrentPeriod'].= substr('0000'.(floor($LOT['output']['Obj']['OpenCount']/60)+1), -4);
$LOT['output']['Obj']['OpenCount'] = 60-fmod($LOT['output']['Obj']['OpenCount'], 60);
$LOT['output']['Obj']['CloseCount'] = $LOT['output']['Obj']['OpenCount']-5;
//$LOT['output']['Obj']['CloseCount'] = 0;
/* 加载赔率信息 */
$sql = 'SELECT `class`, `value` FROM `c_odds_data` WHERE `type`=\'FFK3\' ORDER BY `class` ASC';
