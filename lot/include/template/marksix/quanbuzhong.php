...
<?php for($i=50;$i<=57;$i++){ ?>                                <a id="sub-nav-<?php echo $i; ?>" href="?i=marksix&amp;t=quanbuzhong&amp;p=<?php echo $i; ?>" class="button"><?php echo $LOT['odds'][$i][0][1]; ?></a>
<?php } ?>                            </div>
...
<?php }} ?>
            ...
            <script>
                require(['marksix/buzhong'], function (App) {
                    new App({lotteryId: "marksix", min: <?php echo $LOT['odds'][$LOT['marksix']['pan']][0][5]; ?>, max: <?php echo $LOT['odds'][$LOT['marksix']['pan']][0][5]+3; ?>});
                })
            </script>
