                    ...
                    <div class="main-bd">
                        <div class="clearfix top-bar">
                            <div class="fr nav-button" id="sub-tabs">
                                <a id="sub-nav-5" href="?i=marksix&amp;t=zhengte&amp;p=5" class="button">正1特</a>
                                <a id="sub-nav-6" href="?i=marksix&amp;t=zhengte&amp;p=6" class="button">正2特</a>
                                <a id="sub-nav-7" href="?i=marksix&amp;t=zhengte&amp;p=7" class="button">正3特</a>
                                <a id="sub-nav-8" href="?i=marksix&amp;t=zhengte&amp;p=8" class="button">正4特</a>
                                <a id="sub-nav-9" href="?i=marksix&amp;t=zhengte&amp;p=9" class="button">正5特</a>
                                <a id="sub-nav-10" href="?i=marksix&amp;t=zhengte&amp;p=10" class="button">正6特</a>
                            </div>
...
for($j=0;$j<10;$j++){
    ...
    if($k<50){
        $c = substr('00'.$k, -2);
        $s = show_id($LOT['marksix']['pan'], $k);
?>                                        <tr class="el el<?php echo $c; ?>" data-id="<?php echo $s; ?>" data-odds="">
                                            <td class="table-odd"><i class="icon b-<?php echo $LOT['color'][$k]; ?>"><?php echo $c; ?></i></td>
...
foreach($_list as $k=>$i){
    if(fmod($k, 3)==0){
?>                                        <tr>
<?php }if($i>0){ ?>                                            <td class="table-odd"><?php echo $LOT['odds'][5][1][$i]; ?></td>
                                            <td class="odds-text"><span data-id="<?php echo show_id($LOT['marksix']['pan'], $i); ?>"></span></td>
                                            <td><input type="text" class="input" data-id="<?php echo show_id($LOT['marksix']['pan'], $i); ?>" data-odds=""/></td>
<?php }if(fmod($k, 3)==2){ ?>                                        </tr>
<?php }} ?>                                    </tbody>
                                </table>
                            </div>
                            <div>
            ...
            <script>
                require(['marksix/tema'], function (App) {
                    new App({
                        lotteryId: "marksix",
                        IsTeMa:!1,
                        quick: {
