                    ...
                    <div class="main-bd">
                        <div class="clearfix top-bar">
                            <div class="fr nav-button" id="sub-tabs">
                                <a id="sub-nav-3" href="?i=marksix&amp;t=zhengma&amp;p=3" class="button">正A</a>
                                <a id="sub-nav-4" href="?i=marksix&amp;t=zhengma&amp;p=4" class="button">正B</a>
                            </div>
                            ...
                            <div class="clearfix">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
<?php
$_list = array(50, 51, 52, 53);
foreach($_list as $k=>$i){
?>                                            <td class="table-odd"><?php echo $LOT['odds'][3][1][$i]; ?></td>
