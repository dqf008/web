...
<?php include(IN_LOT.'include/template/marksix/groupWrap.php'); ?>
            <style type="text/css">.aside .odds-amount {border-color:#c61e2f;background:#c61e2f}</style>
...
<?php for($i=58;$i<=63;$i++){ ?>                                <a id="sub-nav-<?php echo $i; ?>" href="?i=marksix&amp;t=lianma&amp;p=<?php echo $i; ?>" class="button"><?php echo $LOT['odds'][$i][0][1]; ?></a>
<?php } ?>                            </div>
...
for($i=1;$i<=49;$i++){
    ...
    if(fmod($i, 5)==1){
?>                                        <tr>
<?php } ?>                                            <td class="table-odd"><i class="icon b-<?php echo $LOT['color'][$a]; ?>"><?php echo $a; ?></i></td>
                                            <td><input type="checkbox" data-id="<?php echo $k; ?>" data-oid="<?php echo $k; ?>" data-key="<?php echo $k; ?>" data-odds="0" data-number="<?php echo $a; ?>" /></td>
...
<?php }} ?>
                            ...
                            <table class="table mt10" id="j-cpd-tb">
                                <tr>
                                    <td>
                                        <label for="hkc-bet1" class="hkc-bet-type"><input type="radio" id="hkc-bet1" name="betType" value="1" data-type="1" data-process="default">正常</label>
                                        <label for="hkc-bet2" class="hkc-bet-type"><input type="radio" id="hkc-bet2" name="betType" value="2" data-type="2" data-process="dt">胆拖</label>
<?php if($LOT['odds'][$LOT['marksix']['pan']][0][5]<3){ ?>                                        <label for="hkc-bet3" class="hkc-bet-type"><input type="radio" id="hkc-bet3" name="betType" value="3" data-type="3" data-process="sx">生肖对碰</label>
                                        <label for="hkc-bet4" class="hkc-bet-type"><input type="radio" id="hkc-bet4" name="betType" value="4" data-type="4" data-process="ws">尾数对碰</label>
                                        <label for="hkc-bet5" class="hkc-bet-type"><input type="radio" id="hkc-bet5" name="betType" value="5" data-type="5" data-process="sw">生尾对碰</label>
                                        <label for="hkc-bet6" class="hkc-bet-type"><input type="radio" id="hkc-bet6" name="betType" value="6" data-type="6" data-process="ry">任意对碰</label>
<?php } ?>                                    </td>
                                </tr>
                            </table>
                            <table class="table nested-table " id="j-bet-tb">
                                <tr class="hide"><td class="j-reset-html">&nbsp;</td></tr>
                                <tr class="hide">
                                    <td>
...
<?php if($LOT['odds'][$LOT['marksix']['pan']][0][5]<3){ ?>                                <tr class="hide">
                                    <td class="p0">
                                        <table>
                                            <tr>
                                ...
                                <tr class="hide">
                                    <td class="p0">
                                        <table>
                                            <tr>
                                                <td><input type="text" value="" name="ws" class="input j-left-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-left-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-left-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-left-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-left-num" data-max="49"/></td>
                                                <td>碰</td>
                                                <td><input type="text" value="" name="ws" class="input j-right-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-right-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-right-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-right-num" data-max="49"/></td>
                                                <td><input type="text" value="" name="ws" class="input j-right-num" data-max="49"/></td>
...
<?php } ?>                            </table>
            ...
            <script>
                require(['marksix/lianma'], function (App) {
                    new App({
                        lotteryId: "marksix",
                        limit: <?php echo $LOT['odds'][$LOT['marksix']['pan']][0][5]; ?>,
