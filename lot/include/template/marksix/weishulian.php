                        ...
                        <div id="parlay-ctn" class="mt10">
                            <div class="ban-bo padded-icon">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><label><input type="radio" name="state" data-pan="34" data-min="2" />中</label></td>
                                            <td><label><input type="radio" name="state" data-pan="35" data-min="3" />中</label></td>
                                            <td><label><input type="radio" name="state" data-pan="36" data-min="4" />中</label></td>
                                        </tr>
                                        <tr>
                                            <td><label><input type="radio" name="state" data-pan="37" data-min="2" />不中</label></td>
                                            <td><label><input type="radio" name="state" data-pan="38" data-min="3" />不中</label></td>
                                            <td><label><input type="radio" name="state" data-pan="39" data-min="4" />不中</label></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="j-content">
...
<?php } ?>                                                <td class="table-odd"><?php echo $a; ?>尾</td>
                                                ...
                                                <td>
                                                    <div class="clearfix"><?php foreach($balls[$a] as $k){ ?><span class="fl icon b-<?php echo $LOT['color'][$k]; ?>"><?php echo $k; ?></span><?php } ?></div>
                                                </td>
