...
<script>
    ...
    $('#nav_jssc').addClass('group_active');
</script>
...
<?php foreach($LOT['odds'][$i][1] as $key=>$val){ ?>                                                    <tr data-id="<?php echo show_id($i, $key); ?>" data-odds="">
                                                        <td class="table-odd"><?php if(is_numeric($val)){ ?><i class="icon js<?php echo $val; ?>"><?php echo $val; ?></i><?php }else{ echo $val;} ?></td>
                                                        <td><span class="odds-text"></span></td>
                                                        <td class="j-odds"><input type="text" class="input fb"/></td>
                                                    </tr>
<?php } ?>                                                </tbody>
...
<?php } ?>                    </div>
            ...
            <script>require(['lot-index'], function(Lottery){new Lottery({lotteryId: "jssc"})});</script>
