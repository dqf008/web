                    ...
                    <div class="main-bd">
                        <div class="clearfix top-bar">
                            <div class="fr nav-button" id="sub-tabs">
                                <a id="sub-nav-3" href="?i=<?php echo $LOT['action']; ?>&amp;t=zhengte&amp;p=3" class="button">正1特</a>
                                <a id="sub-nav-4" href="?i=<?php echo $LOT['action']; ?>&amp;t=zhengte&amp;p=4" class="button">正2特</a>
                                <a id="sub-nav-5" href="?i=<?php echo $LOT['action']; ?>&amp;t=zhengte&amp;p=5" class="button">正3特</a>
                                <a id="sub-nav-6" href="?i=<?php echo $LOT['action']; ?>&amp;t=zhengte&amp;p=6" class="button">正4特</a>
                                <a id="sub-nav-7" href="?i=<?php echo $LOT['action']; ?>&amp;t=zhengte&amp;p=7" class="button">正5特</a>
                                <a id="sub-nav-8" href="?i=<?php echo $LOT['action']; ?>&amp;t=zhengte&amp;p=8" class="button">正6特</a>
                            </div>
