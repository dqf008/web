        ...
        <div class="main-bd">
            <div class="clearfix top-bar">
                <div class="fr nav-button" id="sub-tabs">
                    <?php for ($i = 38; $i <= 47; $i++) { ?>                                <a
                            id="sub-nav-<?php echo $i; ?>"
                            href="?i=<?php echo $LOT['action']; ?>&amp;t=hexiao&amp;p=<?php echo $i; ?>"
                    ...
                    <div class="j-content">
                        <table class="table">
                            ...
                            for ($i = 1; $i <= 12; $i++) {
                                ...
                                <td>
                                    <div class="clearfix"><?php foreach ($LOT['animal'][$a] as $k) {
                                            if ($k < 49) { ?><span
                                                class="fl icon s-<?php echo $LOT['color'][$k]; ?>"><?php echo substr('00' . $k, -2); ?></span><?php }
                                        } ?></div>
                                </td>
...
<script>
    require(['six/hexiao'], function (App) {
        new App({
