    ...
    <div class="play-bd clearfix">
        <div class="main-bd">
                ...
                <table class="table">
                    ...
                    <?php for ($i = 15; $i <= 20; $i++) { ?>
                        <tr>
                            ...
                            <?php for ($k = 1; $k <= 7; $k++) {
                                $id  = show_id($i, $k);
                                $key = 'j' . substr('0000' . $id, -4); ?>
                                <td>
                                    <label><em class="j-odds vam" data-id="<?php echo $id; ?>"
                                               data-oid="<?php echo $id; ?>"
                                               data-key="<?php echo $key; ?>">0</em></label>
                                </td>
                            <?php } ?>                                    </tr>
                    <?php } ?>                                </tbody>
                </table>
            ...
            <div class="selected-ball clearfix need-auth">
                ...
                <b id="j-selected-count"><span class="j-selected-count">0</span>串<span class="j-selected-count">1</span>@<span
                            class="j-selected-count">0</span></b>
            </div>
        </div>
        <div class="aside">
...
<script>
    require(['six/guoguan'], function (App) {
