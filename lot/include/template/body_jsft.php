...
<script>
    var nav_str = 'pk10#jssc#xyft#jsft';
    var nav_arr;
    var html = '';
    var trans_arr = [];
...
<div id="play" class="play">
    <div class="play-hd clearfix">
        ...
        <ul class="play-category fl" id="play-tab">
            ...
            <li data-target="#j-n3" data-np="2" data-hits="yes" data-trends="yes"><a href="javascript:;">一、二、三、四、五名</a>
            </li>
            ...
            <div class="mt10">
                <div id="j-n1">
                    <table class="table nested-table sm-table mb10">
                        <thead>
                        <tr>
                            <th colspan="4"><?php echo $LOT['odds'][1][0]; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            ...
                            for ($i = 12; $i <= 16; $i++) {
                                ...
                                <td class="p0" width="20%">
                                    <table class=" j-betting">
                                        <thead>
                                        <tr>
                                            <th colspan="3"><?php echo $temp_title[$i]; ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <?php for ($i = 1; $i <= 4; $i++) { ?>
                                <td class="p0">
                                    <table class="j-betting">
                                        <thead class="hide">
                                        <tr>
                                            <th colspan="3"><?php echo $LOT['odds'][1][0]; ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php for ($j = 0; $j < 6; $j++) {
                                            ...
                                            <?php } else {
                                                $key >= 21 && $key -= 3; ?>
                                                <tr data-id="<?php echo show_id(1, $key); ?>" data-odds="">
                            ...
                            <?php for ($i = 2; $i <= 6; $i++) { ?>
                                <td class="p0">
                                    <table class=" j-betting">
                                        ...
                                        <tbody>
                                        <?php foreach ($LOT['odds'][$i][1] as $key => $val) { ?>
                                            <tr data-id="<?php echo show_id($i, $key); ?>" data-odds="">
                                                <td class="table-odd"><?php if (is_numeric($val)) { ?><i
                                                        class="icon ft<?php echo $val; ?>"><?php echo $val; ?></i><?php } else {
                                                        echo $val;
                                                    } ?></td>
                                                <td><span class="odds-text"></span></td>
                                                <td class="j-odds"><input type="text" class="input fb"/></td>
