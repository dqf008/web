                            ...
                            <?php for ($i = 1; $i <= 5; $i++) { ?>
                                <td class="p0" width="20%">
                                    <table class="j-betting">
                                        ...
                                        <tbody>
                                        <tr data-id="<?php echo show_id(2, $i); ?>" data-odds="">
                                            <td class="table-odd"><?php echo $LOT['odds'][2][1][$i]; ?></td>
                                            <td><span class="odds-text"></span></td>
                                            <td class="j-odds"><input type="text" class="input fb"/></td>
                                        </tr>
                                        </tbody>
                            ...
                            <?php for ($i = 1; $i <= 3; $i++) { ?>
                                <td class="p0">
                                    <table class="j-betting">
                                        <thead>
                                        <tr>
                                            <th colspan="3" class="hide">盘位</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php for ($k = 3; $k <= 4; $k++) { ?>
                                            <tr data-id="<?php echo show_id($k, $i); ?>" data-odds="">
                                                <td class="table-odd"><?php echo $LOT['odds'][$k][1][$i]; ?>盘</td>
                                                <td><span class="odds-text"></span></td>
                                                <td class="j-odds"><input type="text" class="input fb"/></td>
                                            </tr>
                                        <?php } ?>                                                    </tbody>
