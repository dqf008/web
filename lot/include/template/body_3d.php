                            ...
                            <?php for ($i = 3; $i > 0; $i--) { ?>
                                <td class="p0">
                                    <table class="j-betting">
                                        <thead>
                                        <tr>
                                            <th colspan="3"><?php echo $LOT['odds'][$i][0][2]; ?>位</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php for ($k = 1; $k <= 10; $k++) { ?>
                                            <tr data-id="<?php echo show_id($i, $k); ?>" data-odds="">
                                                <td class="table-odd"><i
                                                            class="icon ball"><?php echo $LOT['odds'][$i][1][$k]; ?></i>
                                                </td>
                                        ...
                                        <?php }
                                        for ($k = 1; $k <= 4; $k++) { ?>
                                            <tr data-id="<?php echo show_id($i + 3, $k); ?>" data-odds="">
                            ...
                            <?php for ($i = 1; $i <= 5; $i++) { ?>
                                <td class="p0">
                                    <table class="j-betting">
                                        <thead>
                                        <tr>
                                            <th colspan="3" class="hide">跨度</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php for ($k = 0; $k < 2; $k++) { ?>
                                            <tr data-id="<?php echo show_id(9, $i + ($k * 5)); ?>" data-odds="">
                            ...
                            <?php for ($i = 1; $i <= 4; $i++) { ?>
                                <td class="p0">
                                    <table class="j-betting">
                                        <thead>
                                        <tr>
                                            <th colspan="3" class="hide">和值</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php for ($k = 0; $k < 8; $k++) { ?>
                                            <tr data-id="<?php echo show_id(8, $i + ($k * 4)); ?>" data-odds="">
                        ...
                        <tr>
                            <td class="p0">
                                <table class="j-betting">
                                    <thead>
                                    <tr>
                                        <th colspan="3" class="hide">区域</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php for ($i = 1; $i <= 7; $i++) { ?>
                                        <tr data-id="<?php echo show_id(7, $i); ?>" data-odds="">
                                            <td class="table-odd"
                                                style="width:150px"><?php echo $LOT['odds'][7][1][$i]; ?></td>
                                            <td><span class="odds-text"></span></td>
                                            <td class="j-odds"><input type="text" class="input fb"/></td>
                                        </tr>
                                    <?php } ?>                                                    </tbody>
