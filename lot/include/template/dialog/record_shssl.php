...
$sql = 'SELECT * FROM `lottery_data` WHERE `username`="'.$LOT['user']['username'].'" AND `atype`="ssl" AND `bet_ok`=0';
$stmt = $mydata1_db->query($sql);
$rows = $stmt->fetchAll();
?>
<div class="tab tab-dialog">
	<h2 style="text-align:center;color:#6f4d28;font-weight:bold">上海时时乐</h2>
