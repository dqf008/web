...
?>
            <div class="tab-colored-bd hide">
                <div class="typo">
                    <h3>温馨提示</h3>
                    <ul>
                        <li>敬告有意与本公司博彩之客户，应注意您所在的国家或居住地可能规定网路博奕不合法，若此情况属实，本公司将不接受任何客户因违反当地博彩或赌博法令所引起之任何责任。</li>
                        <li style="list-style:none">
                            <ol>
                                <li>当您在下注之后，请等待下注后的成功提示信息。</li>
                                <li>为了避免出现争论，您必须在下注之后检查“下注明细”。若有异常，请立即与上级联系查证，否则一切交易将以本公司资料库中资料为淮，不得异议。</li>
                                <li>任何的投诉必须在开奖之前提出，本公司不会受理任何开奖之后的投诉。</li>
                                <li>所有投注项目，公布赔率时出现的任何打字错误或非故意人为失误，本公司保留改正错误和按正确赔率结算投注的权力。</li>
                                <li>公布所有赔率为浮动赔率，下注时请确认当前赔率及金额，下注确认后一概不能更改。开奖后的投注，将被视为「无效」。</li>
                                <li>倘若发生遭黑客入侵破坏行为或不可抗拒之灾害导致网站故障或资料损坏，资料丢失等情况，我们将以本公司线上交易之后备资料为最后处理依据；为确保各方真实利益，请各会员交易后列印资料，本公司才接受投诉及处理。</li>
                                <li>下注前请先认真了解游戏规则，下注后表示您了解以及同意以上的协议和规则。</li>
                            </ol>
                        </li>
                    </ul>
                    <h3>游戏简介</h3>
                    <ul>
                        <li>官方网站：<a href="http://bet.hkjc.com/marksix/?lang=ch" target="_blank">http://bet.hkjc.com/marksix/?lang=ch</a></li>
                        <!--li>参考网址：<a href="http://www.1392c.com/gdkl10/kaijiang/" target="_blank">http://www.1392c.com/gdkl10/kaijiang/</a></li-->
                        <li>该游戏的投注时间、开奖时间和开奖号码与“香港六合彩”完全同步，开奖时间为香港时间（GMT+8）每个星期的二、四、六晚上21:30。</li>
                        <li style="color:red">以上开奖时间仅供参考，官方会根据情况对开奖时间进行提前、顺延或取消，具体请留意本站公告或登陆官方网址查询。</li>
                    </ul>
                    <h3>游戏玩法</h3>
                    <ol>
                        <li>以下所有投注皆含本金。</li>
