...
//$params = array(':qishu' => date('Ymd', $qtime));
$qishu = date('Ymd', $qtime);
$sql = 'SELECT * FROM `c_auto_8` WHERE `qishu` like "'.$qishu.'___"  ORDER BY `qishu` DESC';
...
<?php for($i=1;$i<=10;$i++){ ?>                                    <span class="icon ft<?php echo $rows['ball_'.$i]; ?>">&nbsp;</span>
<?php } ?>                                </td>
