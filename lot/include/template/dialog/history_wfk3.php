...
$limit = 20;
$params = array(':type' => 'WFK3', ':qtime' => strtotime($qtime.' 00:00:00'), ':etime' => strtotime($qtime.' 23:59:59'));
...
?>                            <tr>
                                ...
                                <td><?php echo date('Y-m-d H:i:s', $rows['opentime']); ?></td>
                                <td>
<?php foreach($rows['value']['opencode'] as $ball){ ?>                                    <span class="icon ball"><?php echo $ball; ?></span>
<?php } ?>                                </td>
