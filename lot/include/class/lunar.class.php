<?php
/* 阴阳日历互转，算法来源：http://www.cnblogs.com/qingsong/p/5931984.html */
class Lunar {
    var $MIN_YEAR = 1891;
    var $MAX_YEAR = 2100;
    var $lunarInfo = array(
    ...
    */
    ...
    function getLunarByBetween($year,$between){
        ...
        if($between==0){
            ...
            array_push($lunarArray, $year, $my_year,'正月','初一');
            $t = 1;
            $e = 1;
        }else{
            ...
            $my_year = $this->toYear($year);
            array_push($lunarArray,$year,$my_year,$m,$this->getCapitalNum($e,false));
        }
