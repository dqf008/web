...
<head> 
  ...
  <style> 
  #haoma span{ 
	  text-align: center;width:22px;height: 22px;line-height: 23px;font-size: 14px;padding: 2px;display: inline-block;font-weight: bold;font-family: "微软雅黑";
  } 
  .ball_r{ 
	  color:#FFF;
...
<body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" data-theme="a"  tabindex="0" style="min-height: 892px;"> 
  ...
  <section class="sliderWrap clearfix"> 
	  <div data-role="header" style="overflow:hidden;" role="banner" class="ui-header ui-bar-inherit"> 
		  <h1 class="ui-title" role="heading" aria-level="1">排列3</h1> 
	  </div> 
  </section> 
  ...
  <section class="mContent clearfix" style="padding:0px;"> 
	  <div data-role="cotent"> 
		  ...
		  <?php 
		  	$sqlk = 'select * from lottery_k_pl3 where ok=1 order by id desc limit 10';
			...
			<li data-role="list-divider" role="heading" class="ui-li-divider ui-bar-inherit ui-first-child"> 
					  <label>开奖期数：<?=$rowk['qihao'];?></label> 
				  </li> 
				  <li class="ui-li-static ui-body-inherit"> 
					  <label>开奖时间：<?=$rowk['fengpan'];?></label> 
				  </li> 
				  <li class="ui-li-static ui-body-inherit"> 
					  <label id="haoma">号码： 
						  <span class="ball_r"><?=$rowk['hm1'];?></span> 
						  <span class="ball_r"><?=$rowk['hm2'];?></span> 
						  <span class="ball_r"><?=$rowk['hm3'];?></span> 
					  </label> 
				  </li> 
				  <li class="ui-li-static ui-body-inherit"> 
					  <label>和值：<?=$hzdx.$hzds;?></label> 
				  </li>
				  <?php 
				  $i++;
				}?> 			  
