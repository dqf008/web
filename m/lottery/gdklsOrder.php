...
if (count($datas) <= 0){
	echo '<script type="text/javascript">alert("该页面为提交注单页面无法刷新，返回下注页面！");window.location.href="/m/lottery/gdkls.php";</script>';
	exit();
}
	  ...
	  <div data-role="tabs" id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all"> 
		  ...
		  <div style="clear:both;padding-top:10px;padding-left:10px;"> 
			  <div style="clear:both;text-align:center;"> 
				  <a href="javascript:window.location.href='gdkls.php';" class="ui-btn ui-btn-inline"> 
					  继续下注 
				  </a> 
