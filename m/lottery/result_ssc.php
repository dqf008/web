...
include_once '../../Lottery/include/auto_class.php';
$uid = $_SESSION['uid'];
...
<body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" data-theme="a"  tabindex="0" style="min-height: 892px;"> 
  ...
  <section class="sliderWrap clearfix"> 
	  <div data-role="header" style="overflow:hidden;" role="banner" class="ui-header ui-bar-inherit"> 
		  <h1 class="ui-title" role="heading" aria-level="1">重庆时时彩</h1> 
	  </div> 
  </section> 
  ...
  <section class="mContent clearfix" style="padding:0px;"> 
	  <div data-role="cotent"> 
		  <form action="result_ssc.php" method="get" name="lt_form" data-role="none" data-ajax="false"> 
		  ...
		  <?php 
			...
			$sql = 'select * from c_auto_2 where qishu like :datetime order by qishu desc';
			...
			?>						  
				<li data-role="list-divider" role="heading" class="ui-li-divider ui-bar-inherit ui-first-child"> 
					  ...
					  <li class="ui-li-static ui-body-inherit"> 
						  <label>总和：<?=Ssc_Auto($hm, 1);?> /<?=Ssc_Auto($hm, 2);?> /<?=Ssc_Auto($hm, 3);?></label> 
					  </li> 
					  <li class="ui-li-static ui-body-inherit"> 
						  <label>龙虎：<?=Ssc_Auto($hm, 4);?></label> 
					  </li> 
					  <li class="ui-li-static ui-body-inherit"> 
						  <label>前三/中三/后三：<?=Ssc_Auto($hm, 5);?> /<?=Ssc_Auto($hm, 6);?> /<?=Ssc_Auto($hm, 7);?></label> 
					  </li>	  
			<?php 
					  $i++;
				}
			...
			?>				  
				<li class="ui-li-static ui-body-inherit ui-last-child"> 
				  <div style="clear:both;text-align:left;margin:10px auto;line-height:28px;"> 
					  ...
					  <a class="ui-link" href="result_ssc.php?t=<?=$t;?>&page=1">首页</a> 
					  <a class="ui-link" href="result_ssc.php?t=<?=$t;?>&page=<?=($thisPage - 1) < 1 ? 1 : $thisPage - 1;?>">上一页</a> 
					  <a class="ui-link" href="result_ssc.php?t=<?=$t;?>&page=<?=$total_page < ($thisPage + 1) ? $total_page : $thisPage + 1;?>">下一页</a> 
					  <a class="ui-link" href="result_ssc.php?t=<?=$t;?>&page=<?=$total_page;?>">末页</a> 
				  </div>     
			  </li>
			 <?php }?> 			 
		 </ul> 
