...
<body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" data-theme="a"  tabindex="0" style="min-height: 892px;"> 
  ...
  <section class="sliderWrap clearfix"> 
	  <div data-role="header" style="overflow:hidden;" role="banner" class="ui-header ui-bar-inherit"> 
		  <h1 class="ui-title" role="heading" aria-level="1">极速六合</h1> 
	  </div> 
  </section> 
  ...
  <section class="mContent clearfix" style="padding:0px;"> 
	  <div data-role="cotent"> 
		  <form action="result_jslh.php" method="get" name="lt_form" data-role="none" data-ajax="false"> 
		...
		?>						  
					  ...
					  <li class="ui-li-static ui-body-inherit"> 
						  <label>号码： 
							  <?php $last = array_pop($rows['value']['opencode']);foreach($rows['value']['opencode'] as $ball){ ?><img src="../../lotto/images/num<?=$ball;?>.gif" /><?php } ?><b>+</b><img src="../../lotto/images/num<?=$last;?>.gif" />
						  </label> 
					  </li> 
                      <li class="ui-li-static ui-body-inherit"> 
                          <label>正码：</label> 
                          <div class="ui-grid-a"> 
                              ...
                              <div class="ui-block-b"><span><?php $last = array_pop($rows['value']['animal']);echo implode('&nbsp;', $rows['value']['animal']); ?></span></div> 
                          </div> 
                      </li>
                      <li class="ui-li-static ui-body-inherit"> 
                          <label>特码：</label> 
                          <div class="ui-grid-a"> 
                              <div class="ui-block-a"><span>生肖</span></div> 
                              <div class="ui-block-b"><span><?php echo $last; ?></span></div> 
                              <div class="ui-block-a"><span>单双</span></div> 
                              <div class="ui-block-b"><span><span class='Font_R'><?php echo $rows['value']['info'][3]; ?></span></span></div> 
                              <div class="ui-block-a"><span>大小</span></div> 
                              <div class="ui-block-b"><span><span class='Font_R'><?php echo $rows['value']['info'][4]; ?></span> </span></div> 
                              <div class="ui-block-a"><span>合数单双</span></div> 
                              <div class="ui-block-b"><span><span class='Font_R'><?php echo $rows['value']['info'][5]; ?></span> </span></div> 
                              <div class="ui-block-a"><span>波色</span></div> 
                              <div class="ui-block-b"><span><span class='Font_R'><?php echo $rows['value']['info'][6]; ?></span> </span></div> 
                          </div> 
                      </li> 
                      <li class="ui-li-static ui-body-inherit"> 
                          <label>总数：</label> 
                          <div class="ui-grid-a"> 
                              ...
                              <div class="ui-block-b"><span><?php echo $rows['value']['info'][0]; ?></span>
                              </div> 
                              <div class="ui-block-a"><span>单双</span></div> 
                              <div class="ui-block-b"><span><span style="color:red;"><span class='Font_R'><?php echo $rows['value']['info'][1]; ?></span> </span></span></div> 
                              <div class="ui-block-a"><span>大小</span></div> 
                              <div class="ui-block-b"><span><span style="color:red;"><span class='Font_R'><?php echo $rows['value']['info'][2]; ?></span> </span></span></div> 
                          </div> 
                      </li>
				<?php $i++;
				  }
				...
				<li class="ui-li-static ui-body-inherit ui-last-child"> 
				  <div style="clear:both;text-align:left;margin:10px auto;line-height:28px;"> 
					  ...
					  <a class="ui-link" href="result_jslh.php?t=<?=$t;?>&page=1">首页</a> 
					  <a class="ui-link" href="result_jslh.php?t=<?=$t;?>&page=<?=($thisPage - 1) < 1 ? 1 : $thisPage - 1;?>">上一页</a> 
					  <a class="ui-link" href="result_jslh.php?t=<?=$t;?>&page=<?=$total_page < ( $thisPage + 1) ? $total_page : $thisPage + 1;?>">下一页</a> 
					  <a class="ui-link" href="result_jslh.php?t=<?=$t;?>&page=<?=$total_page;?>">末页</a> 
				  </div>     
			  </li>
			  <?php }?> 			  
			</ul> 
