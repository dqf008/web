  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        window.reload = function(){
            window.post({action: "info", type: "lines", lotteryId: "jslh", lotteryPan: "zhengma6", panType: "9"}, function(d){
    ...
    (function($) {
	  ...
	  <section class="mContent clearfix" style="padding:0px;"> 
          ...
          <?php for($id1=9;$id1<=14;$id1++){$val = $odds[$id1]; ?>
              <div style="padding: 0 15px 10px 10px;" data-role="collapsible" class="ui-collapsible ui-collapsible-themed-content ui-collapsible-collapsed ui-first-child"> 
                  <h4 class="ui-collapsible-heading ui-collapsible-heading-collapsed"><?php echo $val[0][0]; ?></h4> 
                  <div class="ui-grid-b"> 
                  ...
                  <div class="ui-grid-b"> 
                    <?php foreach($val[1] as $id2=>$text){$id2=show_id($id1, $id2); ?>
                      ...
                      <div class="ui-block-c caipiao-bgc-c" data-id="<?php echo $id2; ?>" data-class="<?php echo $val[0][0]; ?>" data-type="<?php echo $text; ?>" data-odds="0"> 
