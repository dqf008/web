...
<html class="ui-mobile ui-mobile-viewport ui-overlay-a"> 
  ...
  <body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" tabindex="0" style="min-height: 659px;"> 
	  ...
	  <section class="sliderWrap clearfix"> 
		  ...
		  <?php if (0 < $tcou){?> 				  
		  	  <div style="font-size:12pt;">第<span style="color:#f60;"><?=$trow['qihao'];?></span>期</div> 
	  ...
	  <script type="text/javascript"> 
		  ...
		  function sub_addbet() { //确认下注 
			  ...
			  var url = '';
			  if (stype == 1) { 
				  url = "3d_ck.php?stype=1&bw=" + bwhm + "&sw=" + swhm + "&gw=" + gwhm;
			  } 
			  if (stype == 2) { 
				  url = "3d_ck.php?stype=2&sw=" + swhm;
			  } 
			  if (stype == 3) { 
				  url = "3d_ck.php?stype=3&bw=" + bwhm + "&sw=" + swhm;
			  } 
			  if (stype == 4) { 
				  url = "3d_ck.php?stype=4&bw=" + bwhm + "&sw=" + swhm + "&gw=" + gwhm;
			  } 
			  if (stype == 5) { 
				  url = "3d_ck.php?stype=5&bw=" + bwhm + "&sw=" + swhm + "&gw=" + gwhm;
			  } 
			  if (url != '') { 
		  ...
		  function sub_addkdbet(id) { //确认下注-跨度 
			  ...
			  var url = '';
			  url = "3d_ck.php?stype=6&content=" + id;
			  window.location.href = url;
			  $('#radio-choice-h-2a').click();
		  } 
		  function sub_addhzbet(id) { //确认下注-和值 
			  ...
			  var url = '';
			  url = "3d_ck.php?stype=7&content=" + id;
			  window.location.href = url;
			  $('#radio-choice-h-2a').click();
		  } 
		  function sub_adddxbet(class3, id) { //确认下注-大小单双 
			  ...
			  var url = '';
			  url = "3d_ck.php?stype=8&class3=" + class3 + "&content=" + id;
			  window.location.href = url;
			  $('#radio-choice-h-2a').click();
		  } 
		  function showMsg() { 
