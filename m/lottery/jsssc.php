...
$odds = include(IN_LOT.'include/odds/jsssc.php');
    ...
    $(document).ready(function(){
        ...
        var x = {
            ...
            load: function(){
                ...
                t.post({action: "info", lotteryId: "jsssc"}, function(d){
            ...
            submit: function(){
                ...
                pankouflag ? (
                    ...
                    d.length>0 ? confirm("共 ￥"+s+" / "+c+" 笔，确定下注吗？\n\n下注明细如下：\n\n"+m.join("\n")) && t.post({action: "bet", betParameters: d, lotteryId: "jsssc"}, function(r){
