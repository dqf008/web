...
$type = isset($_GET['t'])&&in_array($_GET['t'], array_keys($list))?$_GET['t']:'erzhong';
?>
<!DOCTYPE html> 
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        window.reload = function(){
            window.post({action: "info", type: "lines", lotteryId: "jslh", lotteryPan: "weishulian", panType: "<?php echo $list[$type]; ?>"}, function(d){
