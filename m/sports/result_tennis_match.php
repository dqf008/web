  ...
  <section class="mContent clearfix" style="padding:0px;"> 
	  <div data-role="cotent"> 
		  ...
		  <?php 
			...
			$sql = 'select Match_Date,Match_Time, match_name,match_master,match_guest,MB_Inball,TG_Inball from mydata4_db.tennis_match where MB_Inball is not null and  match_Date=:match_Date and match_js=1';
