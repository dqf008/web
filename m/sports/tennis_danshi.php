...
<head> 
  ...
  <script type="text/javascript" src="../sports/js/tennis_danshi.js"></script> 
  <script type="text/javascript" src="../sports/js/tennis_match.js"></script> 
  <style> 
	  .mContent table{ 
		  width:100%;
...
<body class="mWrap ui-page ui-page-theme-a ui-page-active mobile" data-role="page" tabindex="0" style="min-height: 659px;"  onload="loaded(document.getElementById('league').value,0);"> 
  ...
  <!--头部结束--><?php include_once 'common/show_bet.php';?>	  
