...
<head> 
  ...
  <script type="text/javascript" src="../sports/js/result_baseball_match.js"></script> 
	  ...
	  <div data-role="cotent"> 
		  <ul data-role="listview" class="ui-listview">
			  ...
			  <li class="ui-li-static ui-body-inherit"> 
				  <div style="float:left;">网球 -> 网球结果</div> 
			  </li>  	
			  <li class="ui-li-static ui-body-inherit"> 
		  ...
		  <?php 
			...
			$sql = 'select Match_Date,Match_Time, match_name,match_master,match_guest,MB_Inball,TG_Inball from mydata4_db.volleyball_match where MB_Inball is not null and  match_Date=:match_Date and match_js=1';
