...
//加载盘口信息
function loadinfo(){
    $.post("../../Lottery/class/odds_4.php", function(data)
        {
           if(data.opentime>0){
...
//更新开奖号码
function auto(ball){
    $.post("../../Lottery/class/auto_4.php", {ball : ball}, function(data)
        {
...
function sub_bet(){
	...
	$.post("../../Lottery/Include/Lottery_PK.php", function(data) {
		...
		var ok = confirm(txt);
		if (ok)
		document.bjscOrder.submit()
		document.bjscOrder.reset()
	}, "json");
}
//是否登录
function isLogin(){
