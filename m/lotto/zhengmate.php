...
$class1 = '正特';
$class2 = $_GET['ids'];
$class2Array = array('正1特', '正2特', '正3特', '正4特', '正5特', '正6特');
if (!in_array($class2, $class2Array)){
	$class2 = '正1特';
}
...
<body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" tabindex="0" style="min-height: 736px;">
  ...
  <section class="mContent clearfix" style="padding:0 1px 0 2px;">
	  ...
	  <div style="clear:both;" data-role="none">
		  <div class="ui-grid-b">
			  <div class="ui-block-a lhc-bgc-abc"><span>号码</span></div>
			  ...
			  ?>
				  ...
				  <div class="lhc-circle-a">
					  <span class="lhc-circle-b"><?=$haoma;?></span>
				  </div>
			  </div>
		  ...
		  <div class="ui-grid-b">
			  ...
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl50" style="color:red;"><?=$plArray[50]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_50" id="num_50" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_50" id="vnum_50" value="<?=$plArray[50]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span>双</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl51" style="color:red;"><?=$plArray[51]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_51" id="num_51" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_51" id="vnum_51" value="<?=$plArray[51]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span>大</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl52" style="color:red;"><?=$plArray[52]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_52" id="num_52" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_52" id="vnum_52" value="<?=$plArray[52]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span>小</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl53" style="color:red;"><?=$plArray[53]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_53" id="num_53" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_53" id="vnum_53" value="<?=$plArray[53]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span>合数单</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl54" style="color:red;"><?=$plArray[54]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_54" id="num_54" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_54" id="vnum_54" value="<?=$plArray[50]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span>合数双</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl55" style="color:red;"><?=$plArray[55]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_55" id="num_55" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_55" id="vnum_55" value="<?=$plArray[55]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span style="color:red;">红&nbsp;波</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl56" style="color:red;"><?=$plArray[56]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_56" id="num_56" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_56" id="vnum_56" value="<?=$plArray[56]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span style="color:green;">绿&nbsp;波</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl57" style="color:red;"><?=$plArray[57]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_57" id="num_57" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_57" id="vnum_57" value="<?=$plArray[57]['rate'];?>">
			  </div>
			  <div class="ui-block-a lhc-bgc-a1">
				  <span style="color:blue;">蓝&nbsp;波</span>
			  </div>
			  <div class="ui-block-b lhc-bgc-b">
				  <span id="bl58" style="color:red;"><?=$plArray[58]['rate'];?></span>
			  </div>
			  <div class="ui-block-c lhc-bgc-c">
				  <input type="text" name="num_58" id="num_58" maxlength="7" style="width:80%;" data-role="none">
				  <input type="hidden" name="vnum_58" id="vnum_58" value="<?=$plArray[58]['rate'];?>">
			  </div>
		  </div>
	  </div>
