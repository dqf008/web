...
<head> 
  ...
  <body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" tabindex="0" style="min-height: 659px;"> 
	  ...
	  <form name="form" id="form" action="weishulian_katan.php" method="POST"> 
			  ...
			  <div id="three" class="ui-body-d ui-content" style="padding:0px;"> 
				  ...
				  <div class="xiazhu" style="clear:both;" data-role="none"> 
					  ...
					  ?>							  
						  ...
						  <li style="border-top:1px solid #DDD;font-weight: bold;background-color:#EDEDED;width:30%;" 
							  data-role="none"> 
								  <p><?=$obj['class3'];?><input type="hidden" name="class3_<?=$i;?>"  value="<?=$obj['class3'];?>" /> 
								  </p> 
							  </li> 
							  <li style="border-top:1px solid #DDD;font-weight: bold;background-color:#EDEDED;width:20%;" 
							  data-role="none"> 
							  ...
							  data-role="none"><?=$obj['money'];?>								  <input type="hidden" name="money_<?=$i;?>" value="<?=$obj['money'];?>" /> 
							  </li> 
							  <li style="border-top:1px solid #DDD;font-weight: bold;background-color:#EDEDED;width:25%;" 
							  data-role="none"> 
								  <p id="win_<?=$i;?>"><?=$obj['money'] * $obj['rate'];?></p> 
							  </li>
					  <?php }?> 						  
					</ul> 
				  </div> 
				  ...
				  <div style="text-align: center;font-weight: bold;"> 
					  <p> 
						  共<?=count($betResults);?>组选号，总金额：<?=$allMoney;?></p> 
				  </div> 
			  </div> 
...
function getM($class2){
	$m = 0;
	if (('二尾连中' == $class2) || ('二尾连不中' == $class2)){
		$m = 2;
	}else if (('三尾连中' == $class2) || ('三尾连不中' == $class2)){
		$m = 3;
	}else if (('四尾连中' == $class2) || ('四尾连不中' == $class2)){
		$m = 4;
	}else{
		echo '参数错误';
		exit();
