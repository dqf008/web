...
<head>
  ...
  <body class="mWrap ui-page ui-page-theme-a ui-page-active" data-role="page" tabindex="0" style="min-height: 659px;">
	  ...
	  <form name="form" id="form" action="guoguan_katan.php" method="POST">
			  ...
			  <div id="three" class="ui-body-d ui-content" style="padding:0px;">
				  ...
				  <div class="xiazhu" style="clear:both;" data-role="none">
					  ...
					  <li style="border-top:1px solid #DDD;font-weight: bold;background-color:#EDEDED;width:50%;"
						  data-role="none">
							  <p>
							  <?=$plArray[$btn]['class2'] ;?>,<?=$plArray[$btn]['class3'];?>
							  <input type="hidden" name="class3_<?=$btn;?>" value="<?=$plArray[$btn]['class3'];?>" />
							  </p>
						  </li>
						  <li style="border-top:1px solid #DDD;font-weight: bold;background-color:#EDEDED;width:50%;"
						  data-role="none">
...
}?> 						  <li style="border-top:1px solid #DDD;font-weight: bold;background-color:#EDEDED;width:100%;"
						  data-role="none">
						  <p><?=$i;?>串1@<span style="color:#FF0000;"><?=sprintf('%.2f',$allpl);?></span>
							  &nbsp;&nbsp;&nbsp;&nbsp;
							  金额：<span style="color:#0000FF;"><?=sprintf('%.2f',$money);?></span>
						  </p>
					  </li>
					  </ul>
				  </div>
