...
<head>
	...
	<style type="text/css">
		...
		body{
			...
			margin:0px auto;
			font-size:12px;
			/*background:#000 url(http://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-236174.jpg);*/
			background:#000 url(skin/clause.jpg) center top no-repeat;
		}
		#header {
			width:760px;
			height:125px;
			background:url(static/images/clause_logo.png) center center no-repeat;
		...
		.head{
			 ...
			 padding-top:15px;
			 color:#FFFFFF;
			 background-color: rgba(4, 33, 45, 0.71);
		}
		.title {
			color:#FFFFFF;
			font-size : 15px;
		...
		.title-style3 a:link, .title-style3 a:visited{
			color: #581B1B;
			border-bottom: 5px solid rgb(82, 41, 9);
			text-decoration: none;
			line-height: 1.5;
			display: block;
		}
		.title-style3 a:hover{
			color: #581B1B;
			border-bottom: 5px dotted rgb(82, 41, 9);
		}
		#footer{
			height:52px;
			line-height:52px;
		...
		color: #FFF;
		font-weight: bold;
		background: #3D3D3D url(skin/clause_btn.gif) no-repeat 0 -80px;
		}
	</style>
</head>
<body>
	<div id="main">
		<div id="header"></div>
		<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" style="border: 1px rgb(21, 85, 121) solid;border-radius:5px;">
			<tbody>
				<tr><td><div align="center" class="head"><span class="title">协议与规则</span></div></td></tr>
				<tr>
					<td colspan="2" valign="top" id="content" style="padding-top:20px;">
						<div>
							<table width="100%">
								<tbody>
									<tr>
										<td width="50%" align="right"><input type="button" class="btn_001" value="我不同意" tabindex="2" onclick="menu_url(17)" /></td>
										<td align="left"><input type="button" class="btn_001" value="我同意" tabindex="1" onclick="menu_url(1)" /></td>
									</tr>
								</tbody>
							</table>
							...
							<div id="rule_all" style="">
								<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
									<tbody>
										<tr><td height="30" class="title-style2"><div align="center"><p align="center">通则</p></div></td></tr>
										<tr>
											<td>
												<ol>
													...
													<li class="title-style1">无风险投注包括在百家乐同时投注的庄闲，单双，大小。龙虎斗中同时投注龙虎，龙双龙单，虎双虎单。在轮盘同时投注黑红，单双，大小等相反的下注，本公司保留权利取消所有优惠、该注单以及单注产生之红利，并停用该会员账号之权利， 。</li>
										...
										<tr><td height="30"><div align="right"><a href="javascript:;" class="title-style3">TOP</a></div></td></tr>
									</tbody>
								</table>
							</div>
							<div id="rule_ipl" style="display: none;">
								<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
									<tbody>
										<tr><td height="30" class="title-style2"><div align="center"><p align="center">娱乐场协议与规则</p></div></td></tr>
										<tr>
											<td>
												<ol>
													...
													<li class="title-style1"> 当荷官不小心同时从牌靴中抽出两张牌，而扫描到的不是按顺序正确的那张牌：<br>（a）若牌局已开牌，而结果不符，系统将根据现况决定牌的先后摆放顺序之开牌结果进行手动开牌，并换上新牌靴开始新局。<br>（b）若牌局未开牌，则由现场公务决定牌的先后摆放顺序，牌局会如常继续。</li>
													...
													<li class="title-style1">同一张牌，扫描了一次出现2张（闲、庄位置各一张）<br>（a）若牌局已开牌，而结果不符，系统将根据视讯荷官完成该局之正确结果进行手动开牌，牌局也将在牌路无误的情况下如常继续。 <br>（b）若牌局未开牌，荷官避开扫描如常开牌后，工务将输入牌之正确数码，并修正不符那张牌的 花色、点数，牌局会如常继续。</li>
							...
							<div id="rule_ball" style="display: none;">
								<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
									<tbody>
										<tr><td height="30" class="title-style2"><div align="center"><p align="center">运动投注协议与规则</p></div></td></tr>
										<tr>
											<td>
												<ol>
													<li class="title-style1">当您在下注之后，请等待显示下注成功信息。</li>
													<li class="title-style1">为了避免出现争论，您必须在下注之后检查下注状况。</li>
													<li class="title-style1">任何[体育投注]的投诉必须在开赛之前提出，。</li>
							...
							<div id="rule_other" style="display: none;">
								<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
									<tbody>
										<tr><td height="30" class="title-style2"><div align="center"><p align="center">其他游戏</p></div></td></tr>
										<tr>
											<td>
												<ul>
		...
		<div id="footer" align="center">Copyright &copy; <?php echo date('Y').' '.$web_site['web_name']; ?> All Rights Reserved</div>
	</div>
	<script type="text/javascript">
		function chang_rule(rule){
			return $("#"+rule).show().siblings("div").hide()
		}
		(function(){
			chang_rule("rule_all");
			$("a.title-style3").on("click", function(){
