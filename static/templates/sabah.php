...
$sabah = $uid?'cj/live/index.php?type=SHABA':'http://mkt.igame007.cc/?WebSkinType=2&lang=zh';
?>
                ...
                <div class="activity-box">
                    <div class="clearfix">
                        <div style="background:url(Box/GrayCool/images/jbox-content-loading.gif) no-repeat center center">
                            <iframe width="1020" height="900" class="autoSize" frameborder="0" scrolling="no" allowtransparency="true" src="<?php echo $sabah; ?>" id="mainFrame" name="mainFrame"></iframe>
                        </div>
                    </div>
                </div>
            </div>
