...
<?php }else{ ?>						<li class="tab"><a class="<?php echo $action=='index'?'active':''; ?>" href="?action=index"><i class="icon index"></i>代理首页</a></li>
						<li class="tab j-about pointer"><a href="javascript:;"><i class="icon about"></i>关于我们</a></li>
