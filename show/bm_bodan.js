...
function loaded(league,thispage,p){
	...
	$.getJSON("bm_bodan_data.php?leaguename="+league+"&CurrPage="+thispage+"&sort="+sort+"&callback=?",function(json){
		...
		if(dbs == null){
			...
			for(var i=0; i<dbs.length; i++){
				...
				if(dbs[i]["Match_Bd20"] !=null && dbs[i]["Match_Bd20"]!="0"){
					...
					var htm = '<span id="PDH2C0'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="2:0" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-2:0\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bd20\',0,0,\''+dbs[i]["Match_Master"]+'\');">'+dbs[i]["Match_Bd20"]+'</span></span>';
				...
				if(dbs[i]["Match_Bdg20"] !=null && dbs[i]["Match_Bdg20"]!="0"){
					...
					var htm = '<span id="PDH0C2'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="0:2" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-0:2\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bdg20\',0,0,\''+dbs[i]["Match_Guest"]+'\');">'+dbs[i]["Match_Bdg20"]+'</span></span>';
				...
				if(dbs[i]["Match_Bd21"] !=null && dbs[i]["Match_Bd21"]!="0"){
					...
					var htm = '<span id="PDH2C1'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="2:1" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-2:1\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bd21\',0,0,\''+dbs[i]["Match_Master"]+'\');">'+dbs[i]["Match_Bd21"]+'</span></span>';
				...
				if(dbs[i]["Match_Bdg21"] !=null && dbs[i]["Match_Bdg21"]!="0"){
					...
					var htm = '<span id="PDH1C2'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="1:2" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-1:2\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bdg21\',0,0,\''+dbs[i]["Match_Guest"]+'\');">'+dbs[i]["Match_Bdg21"]+'</span></span>';
				...
				if(dbs[i]["Match_Bd30"] !=null && dbs[i]["Match_Bd30"]!="0"){
					...
					var htm = '<span id="PDH3C0'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="3:0" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-3:0\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bd30\',0,0,\''+dbs[i]["Match_Master"]+'\');">'+dbs[i]["Match_Bd30"]+'</span></span>';
				...
				if(dbs[i]["Match_Bdg30"] !=null && dbs[i]["Match_Bdg30"]!="0"){
					...
					var htm = '<span id="PDH0C3'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="0:3" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-0:3\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bdg30\',0,0,\''+dbs[i]["Match_Guest"]+'\');">'+dbs[i]["Match_Bdg30"]+'</span></span>';
				...
				if(dbs[i]["Match_Bd31"] !=null && dbs[i]["Match_Bd31"]!="0"){
					...
					var htm = '<span id="PDH3C1'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="3:1" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-3:1\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bd31\',0,0,\''+dbs[i]["Match_Master"]+'\');">'+dbs[i]["Match_Bd31"]+'</span></span>';
				...
				if(dbs[i]["Match_Bdg31"] !=null && dbs[i]["Match_Bdg31"]!="0"){
					...
					var htm = '<span id="PDH1C3'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="1:3" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-1:3\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bdg31\',0,0,\''+dbs[i]["Match_Guest"]+'\');">'+dbs[i]["Match_Bdg31"]+'</span></span>';
				...
				if(dbs[i]["Match_Bd32"] !=null && dbs[i]["Match_Bd32"]!="0"){
					...
					var htm = '<span id="PDH3C2'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="3:2" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-3:2\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bd32\',0,0,\''+dbs[i]["Match_Master"]+'\');">'+dbs[i]["Match_Bd32"]+'</span></span>';
				...
				if(dbs[i]["Match_Bdg32"] !=null && dbs[i]["Match_Bdg32"]!="0"){
					...
					var htm = '<span id="PDH2C3'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="2:3" onclick="javascript:setbet(\'羽毛球单式\',\'波胆-2:3\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Bdg32\',0,0,\''+dbs[i]["Match_Guest"]+'\');">'+dbs[i]["Match_Bdg32"]+'</span></span>';
