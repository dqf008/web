...
function loaded(league,thispage,p){
	...
	$.getJSON("ftz_banquanchang_data.php?leaguename="+league+"&CurrPage="+thispage+"&sort="+sort+"&sel_gd="+sel_gd+"&callback=?",function(json){
		...
		if(dbs == null){
			...
			for(var i=0; i<dbs.length; i++){
				...
				if(dbs[i]["Match_BqMM"] !=null && dbs[i]["Match_BqMM"]!="0"){
					...
					var htm = '<span id="FFHH'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="主/主" onclick="javascript:setbet(\'足球早盘\',\'半全场-主/主\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqMM\',0,0,\'主/主\');">'+dbs[i]["Match_BqMM"]+'</span></span>';
				...
				if(dbs[i]["Match_BqMH"] !=null && dbs[i]["Match_BqMH"]!="0"){
					...
					var htm = '<span id="FFHN'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="主/和" onclick="javascript:setbet(\'足球早盘\',\'半全场-主/和\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqMH\',0,0,\'主/和\');">'+dbs[i]["Match_BqMH"]+'</span></span>';
				...
				if(dbs[i]["Match_BqMG"] !=null && dbs[i]["Match_BqMG"]!="0"){
					...
					var htm = '<span id="FFHC'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="主/客" onclick="javascript:setbet(\'足球早盘\',\'半全场-主/客\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqMG\',0,0,\'主/客\');">'+dbs[i]["Match_BqMG"]+'</span></span>';
				...
				if(dbs[i]["Match_BqHM"] !=null && dbs[i]["Match_BqHM"]!="0"){
					...
					var htm = '<span id="FFNH'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="和/主" onclick="javascript:setbet(\'足球早盘\',\'半全场-和/主\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqHM\',0,0,\'和/主\');">'+dbs[i]["Match_BqHM"]+'</span></span>';
				...
				if(dbs[i]["Match_BqHH"] !=null && dbs[i]["Match_BqHH"]!="0"){
					...
					var htm = '<span id="FFNN'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="和/和" onclick="javascript:setbet(\'足球早盘\',\'半全场-和/和\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqHH\',0,0,\'和/和\');">'+dbs[i]["Match_BqHH"]+'</span></span>';
				...
				if(dbs[i]["Match_BqHG"] !=null && dbs[i]["Match_BqHG"]!="0"){
					...
					var htm = '<span id="FFNC'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="和/客" onclick="javascript:setbet(\'足球早盘\',\'半全场-和/客\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqHG\',0,0,\'和/客\');">'+dbs[i]["Match_BqHG"]+'</span></span>';
				...
				if(dbs[i]["Match_BqGM"] !=null && dbs[i]["Match_BqGM"]!="0"){
					...
					var htm = '<span id="FFCH'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="客/主" onclick="javascript:setbet(\'足球早盘\',\'半全场-客/主\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqGM\',0,0,\'客/主\');">'+dbs[i]["Match_BqGM"]+'</span></span>';
				...
				if(dbs[i]["Match_BqGH"] !=null && dbs[i]["Match_BqGH"]!="0"){
					...
					var htm = '<span id="FFCN'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="客/和" onclick="javascript:setbet(\'足球早盘\',\'半全场-客/和\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqGH\',0,0,\'客/和\');">'+dbs[i]["Match_BqGH"]+'</span></span>';
				...
				if(dbs[i]["Match_BqGG"] !=null && dbs[i]["Match_BqGG"]!="0"){
					...
					var htm = '<span id="FFCC'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="客/客" onclick="javascript:setbet(\'足球早盘\',\'半全场-客/客\',\'' + dbs[i]["Match_ID"] + '\',\'Match_BqGG\',0,0,\'客/客\');">'+dbs[i]["Match_BqGG"]+'</span></span>';
