...
function loaded(league,thispage,p){
	...
	$.getJSON("bkz_danshi_data.php?leaguename="+league+"&CurrPage="+thispage+"&ids="+ids+"&sort="+sort+"&sel_gd="+sel_gd+"&callback=?",function(json){	
		dbs  = null;
			...
			for(var i=0; i<dbs.length; i++){
				...
				if(dbs[i]["Match_BzM"]!="0" || dbs[i]["Match_Ho"]!=0 || dbs[i]["Match_DxXpl"]!="0" || dbs[i]["Match_DsDpl"]!="0"){
					...
					if(dbs[i]["Match_BzM"]>0 && dbs[i]["Match_BzG"]>0){
						...
						var BzM= '<span id="MH'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span onclick="javascript:setbet(\'篮球单式\',\'独赢-'+dbs[i]["Match_Master"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_BzM\',0,0,\''+dbs[i]["Match_Master"]+'\');" title="'+TeamName(dbs[i]["Match_Master"])+'">'+formatNumber(dbs[i]["Match_BzM"],2)+'</span></span>';
						var BzG= '<span id="MC'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span onclick="javascript:setbet(\'篮球单式\',\'独赢-'+dbs[i]["Match_Guest"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_BzG\',0,0,\''+dbs[i]["Match_Guest"]+'\');" title="'+TeamName(dbs[i]["Match_Guest"])+'">'+formatNumber(dbs[i]["Match_BzG"],2)+'</span></span>';
					...
					if(dbs[i]["Match_DFkDpl"]>0 && dbs[i]["Match_DFkXpl"]>0){
						...
						var DxDpl = '<span id="OUHO'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span title="大" onclick="javascript:setbet(\'篮球单式\',\'球队得分:'+dbs[i]["Match_Guest"]+'-大 / 小-'+dbs[i]["Match_DFkDpl"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DFkDpl\',1,0,\''+dbs[i]["Match_DFkDX"]+'\');" >'+formatNumber(dbs[i]["Match_DFkDpl"],2)+'</span></span>';
						var DxXpl = '<span id="OUHU'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span title="小" onclick="javascript:setbet(\'篮球单式\',\'球队得分:'+dbs[i]["Match_Guest"]+'-大 / 小-'+dbs[i]["Match_DFkXpl"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DFkXpl\',1,0,\''+dbs[i]["Match_DFkDX2"]+'\');">'+formatNumber(dbs[i]["Match_DFkXpl"],2)+'</span></span>';
