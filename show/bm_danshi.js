...
function loaded(league,thispage,p){
	...
	$.getJSON("bm_danshi_data.php?leaguename="+league+"&CurrPage="+thispage+"&ids="+ids+"&sort="+sort+"&callback=?",function(json){
		dbs  = null;
			...
			for(var i=0; i<dbs.length; i++){
				...
				//if(dbs[i]["Match_BzM"]!="0" || dbs[i]["Match_Ho"]!=0 || dbs[i]["Match_DxXpl"]!="0" || dbs[i]["Match_DsDpl"]!="0"){
					...
					if(dbs[i]["Match_isMaster"]=="Y"){
						...
						onelayer=onelayer.replace("*GAME_PD*", b_str);
						onelayer=onelayer.replace("*TR_TOP*","class='bet_game_tr_top'");
					}else{
						if(dbs[i]["Match_MasterID"].length != 5){
							...
							//代表非主場
				  			var tmp_Count = top._session["BMi"+dbs[i]["Match_MasterID"][0]].split(" ");
						...
						onelayer=onelayer.replace("*DISPLAY_LIVE*", "style='display:none'");
						onelayer=onelayer.replace("*DISPLAY_MIDFIELD*", "style='display:none'");
						onelayer=onelayer.replace("*GAME_PD*", "");
					...
					if(dbs[i]["Match_BzM"]>0 && dbs[i]["Match_BzG"]>0){
						...
						var BzM= '<span id="MH'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span onclick="javascript:setbet(\'羽毛球单式\',\'独赢-'+dbs[i]["Match_Master"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_BzM\',0,0,\''+dbs[i]["Match_Master"]+'\');" title="'+TeamName(dbs[i]["Match_Master"])+'">'+formatNumber(dbs[i]["Match_BzM"],2)+'</span></span>';
						var BzG= '<span id="MC'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span onclick="javascript:setbet(\'羽毛球单式\',\'独赢-'+dbs[i]["Match_Guest"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_BzG\',0,0,\''+dbs[i]["Match_Guest"]+'\');" title="'+TeamName(dbs[i]["Match_Guest"])+'">'+formatNumber(dbs[i]["Match_BzG"],2)+'</span></span>';
					...
					if(dbs[i]["Match_Ho"]>0 && dbs[i]["Match_Ao"]>0){
						...
						var Ho = '<span id="RH'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span title="'+dbs[i]["Match_Master"]+'" onclick="javascript:setbet(\'羽毛球单式\',\'让盘-'+(dbs[i]["Match_ShowType"]=="H" ? "主让" :"客让")+dbs[i]["Match_RGG"]+"-"+dbs[i]["Match_Master"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_Ho\',1,0,\''+dbs[i]["Match_Master"]+'\');" >'+formatNumber(dbs[i]["Match_Ho"],2)+'</span></span>';
						var Ao = '<span id="RC'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span title="'+dbs[i]["Match_Guest"]+'" onclick="javascript:setbet(\'羽毛球单式\',\'让盘-'+(dbs[i]["Match_ShowType"]=="H" ? "主让" :"客让")+dbs[i]["Match_RGG"]+"-"+dbs[i]["Match_Guest"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_Ao\',1,0,\''+dbs[i]["Match_Guest"]+'\');" >'+formatNumber(dbs[i]["Match_Ao"],2)+'</span></span>';
					...
					if(dbs[i]["Match_DxDpl"]>0 && dbs[i]["Match_DxXpl"]>0){
						...
						var DxDpl = '<span id="OUH'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span title="大" onclick="javascript:setbet(\'羽毛球单式\',\'总分:大 / 小-'+dbs[i]["Match_DxGG1"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DxDpl\',1,0,\''+dbs[i]["Match_DxGG1"]+'\');" >'+formatNumber(dbs[i]["Match_DxDpl"],2)+'</span></span>';
						var DxXpl = '<span id="OUC'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span title="小" onclick="javascript:setbet(\'羽毛球单式\',\'总分:大 / 小-'+dbs[i]["Match_DxGG2"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DxXpl\',1,0,\''+dbs[i]["Match_DxGG2"]+'\');">'+formatNumber(dbs[i]["Match_DxXpl"],2)+'</span></span>';
					...
					if(dbs[i]["Match_DsDpl"]>0 && dbs[i]["Match_DsSpl"]>0){
						...
						var EOO = '<span id="EOO'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span title="单" onclick="javascript:setbet(\'羽毛球单式\',\'总分:单双-单\',\''+dbs[i]["Match_ID"]+'\',\'Match_DsDpl\',0,0,\'单\');">'+formatNumber(dbs[i]["Match_DsDpl"],2)+'</span></span>';
						var EOE = '<span id="EOE'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span title="双" onclick="javascript:setbet(\'羽毛球单式\',\'总分:单双-双\',\''+dbs[i]["Match_ID"]+'\',\'Match_DsSpl\',0,0,\'双\');">'+formatNumber(dbs[i]["Match_DsSpl"],2)+'</span></span>';
					...
					if(dbs[i]["Match_DFzDpl"]>0 && dbs[i]["Match_DFzXpl"]>0){
						...
						var DxDpl = '<span id="OUHO'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span title="大" onclick="javascript:setbet(\'羽毛球单式\',\'球员得分:'+dbs[i]["Match_Master"]+'-大 / 小-'+dbs[i]["Match_DFzDX"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DFzDpl\',1,0,\''+dbs[i]["Match_DFzDX"]+'\');" >'+formatNumber(dbs[i]["Match_DFzDpl"],2)+'</span></span>';
						var DxXpl = '<span id="OUHU'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span title="小" onclick="javascript:setbet(\'羽毛球单式\',\'球员得分:'+dbs[i]["Match_Guest"]+'-大 / 小-'+dbs[i]["Match_DFzDX2"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DFzXpl\',1,0,\''+dbs[i]["Match_DFzDX2"]+'\');">'+formatNumber(dbs[i]["Match_DFzXpl"],2)+'</span></span>';
					...
					if(dbs[i]["Match_DFkDpl"]>0 && dbs[i]["Match_DFkXpl"]>0){
						...
						var DxDpl = '<span id="OUHO'+dbs[i]["Match_ID"]+'" class="'+color_H+'" onclick="Bright(this.id);"><span title="大" onclick="javascript:setbet(\'羽毛球单式\',\'球员得分:'+dbs[i]["Match_Master"]+'-大 / 小-'+dbs[i]["Match_DFkDX"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DFkDpl\',1,0,\''+dbs[i]["Match_DFkDX"]+'\');" >'+formatNumber(dbs[i]["Match_DFkDpl"],2)+'</span></span>';
						var DxXpl = '<span id="OUHU'+dbs[i]["Match_ID"]+'" class="'+color_C+'" onclick="Bright(this.id);"><span title="小" onclick="javascript:setbet(\'羽毛球单式\',\'球员得分:'+dbs[i]["Match_Guest"]+'-大 / 小-'+dbs[i]["Match_DFkDX2"]+'\',\''+dbs[i]["Match_ID"]+'\',\'Match_DFkXpl\',1,0,\''+dbs[i]["Match_DFkDX2"]+'\');">'+formatNumber(dbs[i]["Match_DFkXpl"],2)+'</span></span>';
