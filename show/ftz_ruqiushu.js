...
function loaded(league,thispage,p){
	...
	$.getJSON("ftz_ruqiushu_data.php?leaguename="+league+"&CurrPage="+thispage+"&sort="+sort+"&sel_gd="+sel_gd+"&callback=?",function(json){
		...
		if(dbs == null){
			...
			for(var i=0; i<dbs.length; i++){
				...
				if(dbs[i]["Match_Total01Pl"] !=null && dbs[i]["Match_Total01Pl"]!="0"){
					...
					var htm = '<span id="TT01'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="0~1" onclick="javascript:setbet(\'足球早盘\',\'入球数-0~1\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Total01Pl\',0,0,\'0~1\');">'+dbs[i]["Match_Total01Pl"]+'</span></span>';
				...
				if(dbs[i]["Match_Total23Pl"] !=null && dbs[i]["Match_Total23Pl"]!="0"){
					...
					var htm = '<span id="TT23'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="2~3" onclick="javascript:setbet(\'足球早盘\',\'入球数-2~3\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Total23Pl\',0,0,\'2~3\');">'+dbs[i]["Match_Total23Pl"]+'</span></span>';
				...
				if(dbs[i]["Match_Total46Pl"] !=null && dbs[i]["Match_Total46Pl"]!="0"){
					...
					var htm = '<span id="TT46'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="4~6" onclick="javascript:setbet(\'足球早盘\',\'入球数-4~6\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Total46Pl\',0,0,\'4~6\');">'+dbs[i]["Match_Total46Pl"]+'</span></span>';
				...
				if(dbs[i]["Match_Total7upPl"] !=null && dbs[i]["Match_Total7upPl"]!="0"){
					...
					var htm = '<span id="TOVER'+dbs[i]["Match_ID"]+'" class="'+color+'" onclick="Bright(this.id);"><span  title="7+" onclick="javascript:setbet(\'足球早盘\',\'入球数-7UP\',\'' + dbs[i]["Match_ID"] + '\',\'Match_Total7upPl\',0,0,\'7UP\');">'+dbs[i]["Match_Total7upPl"]+'</span></span>';
