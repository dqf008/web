...
include_once '../class/badminton_match.php';
include_once '../common/function.php';
include_once '../common/logintu.php';
$uid = $_SESSION['uid'];
sessionBet($uid);
islogin_match($uid);
$rows = badminton_match::getmatch_info(intval($_POST['match_id']), $_POST['point_column']);
...
<ul class="ord_betArea_wordTop">
      <!-- 2016-12-14 足球多type所有细单改位罝显示  -->
        ...
        <?
          ...
          $tname = array("第一局","第二局","第三局","下半场","第四局","第五局","分数");
