					...
					<tr>
						<th colspan="8" align="center">
							<div class="Pagination">
								...
								<?=$page->get_htmlPage("record_lhs.php?cn_begin=".$cn_begin."&s_begin_h=".$s_begin_h."&s_begin_i=".$s_begin_i."&cn_end=".$cn_end."&s_end_h=".$s_end_h."&s_end_i=".$s_end_i);?>
							</div>
						</th>
					</tr>
				</table>
