...
if ($_GET['save'] == 'ok') {
    if ($userinfo['iszhuan'] == 1) {
        ...
        if ($liveType == 'MAYA') {
            ...
            $json = giro_PT2($uid, $liveType, $liveMoney, $zz_money, $all);            
        } elseif ($liveType == 'OG2') {
    ...
    <script language="javascript">
        ...
        $(function () {
            $('td[code] span').click(function(){
                ...
                var _self = this;
                var url = '/api/index.php/live/refresh/'+code;
                $.getJSON(url, function (data) {
                    if(data.code == '00'){
                        $(_self).html(data.money);
                    }else{
                        $(_self).html('<span style="color:red;">--</span>');
                    }
                });
            });
            ...
            $('#recovery').click(function () {
                var list = $('[code]'),list2 = new Array(),count = 0;
                $('.loading').show();
                list.each(function (index) {
                    var str = $(list[index]).find('span').html();
                    var money = parseFloat(str);
                    if(money > 1) list2.push(list[index]);                    
                });
                $(list2).each(function (index) {
                    var str = $(list2[index]).find('span').html();
                    var code = $(list2[index]).attr('code');
                    $.post("?save=ok", {"liveMoney": "OUT", "zz_money": "", "liveType": code, "all": 1},function(){
                            ...
                            <form id="form1" name="form1" action="?save=ok" method="post">
                                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" bgcolor="#FAFAFA">MG电子游戏：</td>
                                            <td align="left" code="MG">
                                                <span>0.00</span> &nbsp; 
                                                <a>一键转入</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#FAFAFA">PT电子游戏：</td>
                                        ...
                                        <tr>
                                            <td align="right" bgcolor="#FAFAFA">MW电子游戏：</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" colspan="5">
                                                ...
                                                <input type="radio" name="liveType" value="PT2">新PT电子<br/>
