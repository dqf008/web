			  ...
			  <table width="98%" border="0" cellspacing="0" cellpadding="5"> 
                  ...
                  <tr> 
                      <td height="25" colspan="9" align="center" bgcolor="#3C3C3C" style="color:#FFF">
                        <span style="color:#FF0">【温馨提醒】</span>IPM体育注单需要同步后才能显示，请您耐心等待。
                      </td> 
                  </tr>
				  <tr> 
				  ...
				  <?php
					...
					$sql = 'select id from `ipmbetdetail` where uid=:uid and betTime>=:begin_time and betTime<=:end_time order by id desc';
					...
					{
					$id = rtrim($id, ',');
					$sql	=	"select * from `ipmbetdetail` where id in($id) order by betTime desc";
