				...
				<table width="98%" border="0" cellspacing="0" cellpadding="5">
				    ...
				    <tr> 
					  ...
					  <?php 
						...
						$sql = 'select id from `huikuan` where `uid`=:uid and `adddate`>=:begin_time and `adddate`<=:end_time order by `id` desc';
					...
					<tr>
						<th colspan="8" align="center">
							<div class="Pagination">
								...
								<?=$page->get_htmlPage("data_h_money.php?cn_begin=".$cn_begin."&s_begin_h=".$s_begin_h."&s_begin_i=".$s_begin_i."&cn_end=".$cn_end."&s_end_h=".$s_end_h."&s_end_i=".$s_end_i);?>
							</div>
						</th>
					</tr>
				  </table> 
