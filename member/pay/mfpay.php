  ...
  <head> 
	  ...
	  <script language="JAVAScript"> 
		...
		function VerifyData(payType) {
			...
			$("#qrimg").html("<img src=\"dinpay3.1wx/loading.gif\" style=\"padding-top:130px\" /><br />二维码加载中，请稍后...");
			$.ajax({
						  ...
						  <td align="left" bgcolor="#FFFFFF" style="line-height:22px;"> 
							  <table width="100%" border="0" cellspacing="0" cellpadding="5"> 
								  ...
								  <tr> 
									  ...
									  <td align="left"><input name="SubTran" type="button" class="submit_108" id="SubTran" value="立即支付" onclick="VerifyData();" /></td> 
								  </tr> 
								  </form> 
							  </table> 
						  </td> 
