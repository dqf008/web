					  ...
					  <tr> 
						  <td align="left" bgcolor="#FFFFFF" style="line-height:22px;"> 
							  <table width="100%" border="0" cellspacing="0" cellpadding="5"> 
								  ...
								  <tr>
								    <td align="right" bgcolor="#FAFAFA">电话号码：</td>
								    <td align="left"><input name="mobile" type="text" class="input_150" id="mobile" onkeyup="clearNoNum(this);" maxlength="30" size="15"/> 
								  </tr>
								  <tr>
								    <td align="right" bgcolor="#FAFAFA">银卡姓名：</td>
								    <td align="left"><input name="card_name" type="text" class="input_150" id="card_name"  maxlength="30" size="15"/> 
								  </tr>
								  <tr>
								    <td align="right" bgcolor="#FAFAFA">银卡账号：</td>
								    <td align="left"><input name="card_no" type="text" class="input_150" id="card_no" onkeyup="clearNoNum(this);" maxlength="30" size="15"/> 
								  </tr>
								 
								  <tr>
								    <td align="right" bgcolor="#FAFAFA">身份证号码：</td>
								    <td align="left"><input name="id_no" type="text" class="input_150" id="id_no" onkeyup="clearNoNum(this);" maxlength="20" size="15"/> 
								  </tr>
								  ...
								  <tr> 
									  <td colspan="2" align="center"> 
										  <table border="0" cellspacing="0" cellpadding="0"> 
											  ...
											  <tr height="42"> 
												  <td width="20"><input type="radio" name="Bankco" value="BCOM" /></td> 
											  ...
											  <td width="20"><input type="radio" name="Bankco" value="NJCB-KJB-B2C" /></td> 
											   ...
											   -->
												  ...
												  <td width="20"><input type="radio" name="Bankco" value="CEBB" /></td> 
												  ...
												  <td width="20"><input type="radio" name="Bankco" value="ECITIC" /></td> 
