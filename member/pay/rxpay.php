						  ...
						  <td align="left" bgcolor="#FFFFFF" style="line-height:22px;"> 
							  <table width="100%" border="0" cellspacing="0" cellpadding="5"> 
								  ...
								  <tr> 
									  ...
									  <td align="left"><input name="SubTran" type="submit" class="submit_108" id="SubTran" value="<?php echo $arr_online_config[$pay_online]['online_name']; ?>" /></td> 
								  </tr> 
								  <input type="hidden" name="S_Web" value="true"></input> 
