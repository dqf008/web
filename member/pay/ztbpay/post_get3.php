...
$response = preg_replace('/\/css\//i', 'https://pay.ztbaopay.com/css/', $response);
$response = preg_replace('/\/js\//i', 'https://pay.ztbaopay.com/js/', $response);
$response = preg_replace('/\/images\//i', 'https://pay.ztbaopay.com/images/', $response);
$response = preg_replace('/action=\"Pay\"/i', 'action="https://pay.ztbaopay.com/Pay"', $response);
echo $response;
function post_data($post_data, $url) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt ($ch, CURLOPT_REFERER, "http://tohn.cn/");
