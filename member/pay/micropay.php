					  ...
					  <tr> 
						  <td align="left" bgcolor="#FFFFFF" style="line-height:22px;"> 
							  <table width="100%" border="0" cellspacing="0" cellpadding="5"> 
								  ...
								  <tr> 
									  <td align="right" bgcolor="#FAFAFA">18位条形码：</td> 
									  <td align="left"><input name="auth_code" type="text" class="input_150" id="auth_code" onkeyup="clearNoNum(this);" maxlength="18" size="15"/></td> 
								  </tr>
								  <tr> 
