		...
		<td colspan="2" align="center" valign="middle">
			...
			<div class="content">
				  <table width="98%" border="0" cellspacing="0" cellpadding="5"> 
					  ...
					  <tr> 
						  <td height="25" colspan="6" align="center" bgcolor="#3C3C3C" style="color:#FFF"><?php include_once 'moneysubmenu.php';?>						  </td> 
					  </tr> 
					  <tr> 
						  <td height="25" colspan="6" align="center" bgcolor="#D6D6D6"> 
							  开始日期 
					  ...
					  <?php 
						...
						$sql = 'select m_id from `k_money` where `uid`=:uid and `type`=1 and `m_make_time`>=:begin_time and `m_make_time`<=:end_time order by `m_id` desc';
					...
					<tr>
						<th colspan="6" align="center">
							<div class="Pagination">
								...
								<?=$page->get_htmlPage("data_money.php?cn_begin=".$cn_begin."&s_begin_h=".$s_begin_h."&s_begin_i=".$s_begin_i."&cn_end=".$cn_end."&s_end_h=".$s_end_h."&s_end_i=".$s_end_i);?>
							</div>
						</th>
					</tr> 
				  </table> 
