...
$last_url = "/result/lq_match.php?list_date=".date('Y-m-d',strtotime($date)-24*60*60)."&langx=zh-cn";
if( strtotime(date('Y-m-d', time())) > strtotime($date) ){
	$next_url = "/result/lq_match.php?list_date=".date('Y-m-d',strtotime($date)+24*60*60)."&langx=zh-cn";
}
?> 
       ...
       <div>
          <table cellpadding="0" cellspacing="0" border="0" id="results_tableLine" class="acc_results_table">
             <tr class="acc_results_tr_title">
				...
				<td class="width60">2</td> 
				<td class="width60">3</td> 
				<td class="width60">4</td> 
				<td class="width60">上半</td> 
				<td class="width60">下半</td> 
				<td class="width60">加时</td> 
				<td class="width60">全场</td> 
             </tr>
		<?php 
		$params[':match_Date'] = date('m-d', strtotime($date));
		$sql = 'select Match_Date,Match_Time, match_name,match_master,Match_MatchTime,match_guest,MB_Inball_1st,TG_Inball_1st,MB_Inball_2st,TG_Inball_2st,MB_Inball_3st,TG_Inball_3st,MB_Inball_4st,TG_Inball_4st,MB_Inball_HR,TG_Inball_HR,MB_Inball_ER,TG_Inball_ER,MB_Inball,TG_Inball,MB_Inball_Add,TG_Inball_Add from  mydata4_db.lq_match where MB_Inball_OK is not null and  match_Date=:match_Date and match_js=1 and Match_Guest not like \'% - (%\' group by match_master order by match_coverdate,match_id asc';
		...
		<tr class="acc_results_league">
		    <td colspan="10" ><span><?=$rows["match_name"]?></span></td>
		</tr>
		<?php
				}
		?>
			...
			<tr class="acc_result_tr_top" >
			  ...
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_1st"]>=0 ? $rows["MB_Inball_1st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_2st"]>=0 ? $rows["MB_Inball_2st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_3st"]>=0 ? $rows["MB_Inball_3st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_4st"]>=0 ? $rows["MB_Inball_4st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_HR"]>=0 ? $rows["MB_Inball_HR"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_ER"]>=0 ? $rows["MB_Inball_ER"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball_Add"]<0 ? '无效' : $rows["MB_Inball_Add"]>0 ? $rows["MB_Inball_Add"] : ''; ?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["MB_Inball"]>=0 ? $rows["MB_Inball"] : '无效'?></span></td>
			</tr>

			<tr class="acc_result_tr_other">
			  <td class="acc_result_team  acc_result_full"><?=$rows["match_guest"]?> &nbsp;&nbsp;</td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_1st"]>=0 ? $rows["TG_Inball_1st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_2st"]>=0 ? $rows["TG_Inball_2st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_3st"]>=0 ? $rows["TG_Inball_3st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_4st"]>=0 ? $rows["TG_Inball_4st"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_HR"]>=0 ? $rows["TG_Inball_HR"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_ER"]>=0 ? $rows["TG_Inball_ER"] : '无效'?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball_Add"]<0 ? '无效' : $rows["TG_Inball_Add"]>0 ? $rows["TG_Inball_Add"] : ''; ?></span></td>
			  <td class="acc_result_bg"><span class="BlackWord"><?=$rows["TG_Inball"]>=0 ? $rows["TG_Inball"] : '无效'?></span></td>
			 </tr>
