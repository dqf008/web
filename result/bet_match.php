...
$last_url = "/result/bet_match.php?list_date=".date('Y-m-d',strtotime($date)-24*60*60)."&langx=zh-cn";
if( strtotime(date('Y-m-d', time())) > strtotime($date) ){
	$next_url = "/result/bet_match.php?list_date=".date('Y-m-d',strtotime($date)+24*60*60)."&langx=zh-cn";
}
?> 
