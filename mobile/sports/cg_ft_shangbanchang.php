...
$sporttime = 121;
$sportpage = 'cg_ft_shangbanchang';
$sporttab = 'cg_tab';
$cg_for_message = $_SESSION['cg_for_message'];
...
<head> 
  ...
  <script type="text/javascript" src="js/ft_shangbanchang.js"></script> 
  <script type="text/javascript" src="js/bet_match.js"></script> 
  <style> 
	  .mContent table{ 
		  width:100%;
...
<body class="mWrap ui-page ui-page-theme-a ui-page-active mobile" data-role="page" tabindex="0" style="min-height: 659px;"  onload="loaded(document.getElementById('league').value,0);"> 
  ...
  <input type="hidden" name="touzhutype" id="touzhutype" value="1" /> 
  ...
  <section class="mContent clearfix" style="padding:0px;"> 
	  <div data-role="cotent"> 
		  <ul data-role="listview" class="ui-listview"><?php include_once 'sports_head.php';?>				  <li class="ui-li-static ui-body-inherit"> 
				  <div style="float:left;"> 
					  串关 -> 足球上半场 
				   </div> 
				   <div style="float:right;"> 
					  已经选择赛事：<span id="cg_num" style="color:blue;" onClick="show_cg_message();"><?=count($cg_for_message);?></span> 
								  <span style="color:blue;" onClick="show_cg_message();">（点击查看）</span> 
				  </div> 
			  </li> 
