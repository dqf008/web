...
function loaded(league,thispage,p){
	...
	$.getJSON("/show/ftz_danshi_data.php?leaguename="+league+"&CurrPage="+thispage+"&wap=wap&callback=?",function(json){
		...
		if(pagecount == 0){
			...
			for(var i=0; i<dbs.length; i++){
				if(dbs[i]["Match_BzM"]!="0" || dbs[i]["Match_Ho"]!=0 || dbs[i]["Match_DxXpl"]!="0" || dbs[i]["Match_DsDpl"]!="0"){
					...
					htmls +=			(dbs[i]["Match_BzM"]==null || dbs[i]["Match_BzM"]=="0") ? "" :("<a href=\"javascript:void(0)\" title=\""+dbs[i]["Match_Master"]+"\" onclick=\"javascript:setbet('足球单式','独赢-"+dbs[i]["Match_Master"]+"-独赢','"+dbs[i]["Match_ID"]+"','Match_BzM','0','0','"+dbs[i]["Match_Master"]+"');\" style='"+(dbs[i]["Match_BzM"]!=data[i]["Match_BzM"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFFF00;":"")+"'>"+formatNumber(dbs[i]["Match_BzM"],2)+"</a>");
					htmls +="		</span>";
					htmls +="	</td>";
					htmls +="	<td>";
					htmls +="		<span class=\"odds\">";
					htmls +=				((dbs[i]["Match_BzG"]==null || dbs[i]["Match_BzG"]=="0") ? "" :("<a href=\"javascript:void(0)\" title=\""+dbs[i]["Match_Guest"]+"\" onclick=\"javascript:setbet('足球单式','独赢-"+dbs[i]["Match_Guest"]+"-独赢','"+dbs[i]["Match_ID"]+"','Match_BzG','0','0','"+dbs[i]["Match_Guest"]+"');\" style='"+(dbs[i]["Match_BzG"]!=data[i]["Match_BzG"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFFF00;":"")+"'>"+formatNumber(dbs[i]["Match_BzG"],2)+"</a>"));
					htmls +="		</span>";
					htmls +="	</td>";
					htmls +="	<td>";
					htmls +="		<span class=\"odds\">";
					htmls +=(dbs[i]["Match_BzH"]==null || (dbs[i]["Match_BzH"]-0.05<=0)) ? "" :("<a href=\"javascript:void(0)\" title=\"和局\" onclick=\"javascript:setbet('足球单式','独赢-和局','"+dbs[i]["Match_ID"]+"','Match_BzH','0','0','和局');\" style='"+(dbs[i]["Match_BzH"]!=data[i]["Match_BzH"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFFF00;":"")+"'>"+formatNumber(dbs[i]["Match_BzH"],2)+"</a>");
					htmls +="		</span>";
					htmls +="	</td>";
					htmls +="</tr>";
					...
					htmls +="		<span class=\"odds\">";
					htmls +=				((dbs[i]["Match_Ao"]==null || dbs[i]["Match_Ao"]==0) ?"":("<a href=\"javascript:void(0)\" title=\""+dbs[i]["Match_Guest"]+"\" onclick=\"javascript:setbet('足球单式','让球-"+(dbs[i]["Match_ShowType"]=="H" ? "主让" :"客让")+dbs[i]["Match_RGG"]+"-"+dbs[i]["Match_Guest"]+"','"+dbs[i]["Match_ID"]+"','Match_Ao','1','0','"+dbs[i]["Match_Guest"]+"');\" style='"+(dbs[i]["Match_Ao"]!=data[i]["Match_Ao"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFFF00;":"")+"'>"+formatNumber(dbs[i]["Match_Ao"],2)+"</a>"));
					htmls +="		</span>";
					htmls +="	</td>";
					htmls +="	<td>";
					htmls +="		<span></span>";
					...
					htmls +="		<span class=\"odds\">";
					htmls +=				((dbs[i]["Match_DsDpl"]==null || dbs[i]["Match_DsDpl"]=="0") ? "" :("<a href=\"javascript:void(0)\" title=\"单\" onclick=\"javascript:setbet('足球单式','单双-单','"+dbs[i]["Match_ID"]+"','Match_DsDpl','0','0','单');\" style='"+(dbs[i]["Match_DsDpl"]!=data[i]["Match_DsDpl"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFFF00":"")+"'>"+formatNumber(dbs[i]["Match_DsDpl"],2)+"</a>"));
					htmls +="		</span>";
					htmls +="	</td>";
					htmls +="	<td>";
					htmls +="		<span class=\"pankou\">"+((dbs[i]["Match_DsSpl"]==null || dbs[i]["Match_DsSpl"]=="0") ? "" :("双"))+"</span>";
					htmls +="		<span class=\"odds\">";
					htmls +=				((dbs[i]["Match_DsSpl"]==null || dbs[i]["Match_DsSpl"]=="0") ? "" :("<a href=\"javascript:void(0)\" title=\"双\" onclick=\"javascript:setbet('足球单式','单双-双','"+dbs[i]["Match_ID"]+"','Match_DsSpl','0','0','双');\"  style='"+(dbs[i]["Match_DsSpl"]!=data[i]["Match_DsSpl"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFFF00":"")+"'>"+formatNumber(dbs[i]["Match_DsSpl"],2)+"</a>"));
					htmls +="		</span>";
					htmls +="	</td>";
					htmls +="	<td>";
					htmls +="		<span></span>";
