...
if ($_GET['save'] == 'save')
{
	$params = array(':btm' => $_POST['btm'], ':ctm' => $_POST['ctm'], ':dtm' => $_POST['dtm'], ':btmdx' => $_POST['btmdx'], ':ctmdx' => $_POST['ctmdx'], ':dtmdx' => $_POST['dtmdx'], ':bzt' => $_POST['bzt'], ':czt' => $_POST['czt'], ':dzt' => $_POST['dzt'], ':bztdx' => $_POST['bztdx'], ':cztdx' => $_POST['cztdx'], ':dztdx' => $_POST['dztdx'], ':bzm' => $_POST['bzm'], ':czm' => $_POST['czm'], ':dzm' => $_POST['dzm'], ':bzmdx' => $_POST['bzmdx'], ':czmdx' => $_POST['czmdx'], ':dzmdx' => $_POST['dzmdx'], ':bzm6' => $_POST['bzm6'], ':czm6' => $_POST['czm6'], ':dzm6' => $_POST['dzm6'], ':bbb' => $_POST['bbb'], ':cbb' => $_POST['cbb'], ':dbb' => $_POST['dbb'], ':bsx' => $_POST['bsx'], ':csx' => $_POST['csx'], ':dsx' => $_POST['dsx'], ':bsx6' => $_POST['bsx6'], ':csx6' => $_POST['csx6'], ':dsx6' => $_POST['dsx6'], ':bsxp' => $_POST['bsxp'], ':csxp' => $_POST['csxp'], ':dsxp' => $_POST['dsxp'], ':bth' => $_POST['bth'], ':cth' => $_POST['cth'], ':dth' => $_POST['dth'], ':bzx' => $_POST['bzx'], ':czx' => $_POST['czx'], ':dzx' => $_POST['dzx'], ':blx' => $_POST['blx'], ':clx' => $_POST['clx'], ':dlx' => $_POST['dlx']);
	$sql = 'Update config Set btm=:btm,ctm=:ctm,dtm=:dtm,btmdx=:btmdx,ctmdx=:ctmdx,dtmdx=:dtmdx,bzt=:bzt,czt=:czt,dzt=:dzt,bztdx=:bztdx,cztdx=:cztdx,dztdx=:dztdx,bzm=:bzm,czm=:czm,dzm=:dzm,bzmdx=:bzmdx,czmdx=:czmdx,dzmdx=:dzmdx,bzm6=:bzm6,czm6=:czm6,dzm6=:dzm6,bbb=:bbb,cbb=:cbb,dbb=:dbb,bsx=:bsx,csx=:csx,dsx=:dsx,bsx6=:bsx6,csx6=:csx6,dsx6=:dsx6,bsxp=:bsxp,csxp=:csxp,dsxp=:dsxp,bth=:bth,cth=:cth,dth=:dth,bzx=:bzx,czx=:czx,dzx=:dzx,blx=:blx,clx=:clx,dlx=:dlx where id=1';
...
<table width="99%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="f1f1f1"> 
 <form name=form1 action=index.php?action=xt_abcd&save=save method=post> 
  <tr > 
  ...
  <tr> 
	<td height="25" colspan="4" align="center" bordercolor="cccccc"> 
		<button onclick="submit()"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:100;height:22" ><img src="images/icon_21x21_copy.gif" align="absmiddle" />确认修改</button> 
