...
if ($_GET['act'] == '修改'){
	...
	for (;$tt <= 49;$tt++)
	{
		...
		$params = array(':mrate' => $num, ':class2' => $ids, ':class3' => $_POST['class3_' . $tt]);
		$stmt = $mydata2_db->prepare('update ka_bl set mrate=:mrate where class2=:class2 and  class3=:class3');
		$stmt->execute($params);
	}
	
	echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_mwbz&ids=".$ids."';</script>";
	exit();
}
...
if ($_GET['savew'] == 'savew'){
	...
	for ($f = 0;$f < $ss4;$f++){
		if ($mv == 0){
			$params = array(':mrate' => $money, ':class2' => $ids, ':class3' => $pc4[$f]);
			$stmt = $mydata2_db->prepare('update ka_bl set mrate=rate-:mrate where class2=:class2  and   class3=:class3');
			$stmt->execute($params);
		}else{
			$params = array(':mrate' => $money, ':class2' => $ids, ':class3' => $pc4[$f]);
			$stmt = $mydata2_db->prepare('update ka_bl set mrate=rate+:mrate where class2=:class2  and   class3=:class3');
...
$result = $mydata2_db->prepare('Select mrate,class3,locked from ka_bl where class2=:class2 Order By ID  LIMIT 53');
...
{ 
  ...
  //class1:类别1 
  //ids:(即class2)标记为五不中或七不中；qtqt:调整幅度；lxlx调整方向，1为加，否则为减 
  //class3:调整的类别 
  switch(commandName) 
  { 
...
<link rel="stylesheet" href="xp.css" type="text/css"> 
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
            <form name="form1" method="post" action="index.php?action=rake_mwbz&act=修改&ids=<?=$ids?>">
              <tr bordercolor="cccccc" >
                <td height="28" colspan="10" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="57%"><font color="#FFFFFF"> <strong><?=$ids?>赔率设置</strong></font></td>
...
<td colspan="3" width="90%" align="right">
            &nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=五不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>五不中</span></button>
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=六不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>六不中</span></button>&nbsp;
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=七不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>七不中</span></button>&nbsp;
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=八不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>八不中</span></button>&nbsp;
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=九不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>九不中</span></button>&nbsp;
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=十不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>十不中</span></button>&nbsp;
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=十一不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>十一不中</span></button>&nbsp;
			&nbsp;<button type="button" onClick="javascript:location.href='index.php?action=rake_mwbz&ids=十二不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>十二不中</span></button>&nbsp;
          </td> 
</tr>
             </table></td>
              </tr>
...
?>
              <tr>
                <td height="35" align="center" bordercolor="cccccc" class="ball_<?=Get_bs_Color(intval($I))?>"><img src="images/num<?=$I?>.gif" /></td>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I-1][0]?>" name="Num_<?=$I?>" />
                ...
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?=Get_bs_Color(intval($I+10))?>"><img src="images/num<?=$I+10?>.gif" /></td>
                ...
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?=Get_bs_Color(intval($I+20))?>"><img src="images/num<?=$I+20?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+20-1][0]?>" name="Num_<?=$I+20?>" />
                ...
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?=Get_bs_Color(intval($I+30))?>"><img src="images/num<?=$I+30?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+30-1][0]?>" name="Num_<?=$I+30?>" />
                ...
                <? if ($I!=10) {?>
                <td height="25" align="center" bordercolor="cccccc" class="ball_<?=Get_bs_Color(intval($I+40))?>"><img src="images/num<?=$I+40?>.gif" /></td>
                <td height="25" align="center" bordercolor="cccccc"><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+40-1][0]?>" name="Num_<?=$I+40?>" />
          ...
          <form action="index.php?action=rake_mwbz&savew=savew&ids=<?=$ids?>" name="form21" method="post" >
            <tr align="middle">
   ...
   <form action="index.php?action=rake_mwbz&save=save&ids=<?=$ids?>" name="form21" method="post" ><tr>
