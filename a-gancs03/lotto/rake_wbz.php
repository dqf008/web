...
if ($_GET['act'] == '修改')
{
	...
	for ($tt = 1;$tt <= 49;$tt++){
		...
		if ($tt <= 49){
			$params = array(':rate' => $num1, ':blrate' => $num1, ':class3' => $_POST['class3_' . $tt]);
			$stmt = $mydata2_db->prepare('update ka_bl set rate=:rate,blrate=:blrate where class2=\'' . $ids . '\' and  class3=:class3');
		}
		$stmt->execute($params);
	}
	echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_wbz&ids=".$ids."';</script>";
	exit();
}
...
if ($_GET['savew'] == 'savew'){
	...
	for (;$f < $ss4;$f++)
	{
		if ($mv == 0)
		{
			$params = array(':rate' => $money, ':class2' => $ids, ':class3' => $pc4[$f]);
			$stmt = $mydata2_db->prepare('update ka_bl set rate=rate-:rate where class2=:class2  and   class3=:class3');
			$stmt->execute($params);
		}
		else
		{
...
$result = $mydata2_db->prepare('Select rate,class3,locked from ka_bl where class2=:class2 Order By ID  LIMIT 53');
...
{ 
  ...
  //class1:类别1 
  //ids:(即class2)标记全不中为五不中或七不中；qtqt:调整幅度；lxlx调整方向，1为加，否则为减 
  //class3:调整的类别 
  switch(commandName) 
  { 
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
	 <form name="form1" method="post" action="index.php?action=rake_wbz&act=修改&ids=<?=$ids?>"> <tr bordercolor="cccccc" >
	  <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td><font color="#FFFFFF"><strong><?=$ids?>赔率设置</strong></font></td>
		  <td><div align="right">
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=五不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle">五不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=六不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 六不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=七不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 七不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=八不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 八不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=九不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 九不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=十不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 十不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=十一不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 十一不中</button>&nbsp;
<button type="button" onClick="javascript:location.href='index.php?action=rake_wbz&ids=十二不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 十二不中</button>&nbsp;
		  </div></td>
		</tr>
	  </table></td>
	</tr>
...
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I-1][0]?>" name="Num_<?=$I?>" /></td>
		  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I?>','bl<?=$I-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
			</tr>
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I?>','bl<?=$I-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
			</tr>
		  </table></td>
		  <td><input type=checkbox id=lock<?=$I-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I-1?>','','class1=全不中&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I-1][1]?>&lock='+this.checked);" value="TRUE"  <? if ($ShowTable[$I-1][2]==1){echo "checked";}?>>
		  </input></td>
		</tr>
	  </table>
	 ...
	 <img src="images/num<?=$I+10?>.gif" /></td>
	  <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+10?>','bl<?=$I+10-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
			</tr>
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+10?>','bl<?=$I+10-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
			</tr>
		  </table></td>
		  <td><input type=checkbox id=lock<?=$I+10-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+10-1?>','','class1=全不中&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+10-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+10-1][2]==1){echo "checked";}?>></td>
		</tr>
	  </table>
...
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+20-1][0]?>" name="Num_<?=$I+20?>" /></td>
		  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+20?>','bl<?=$I+20-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
			</tr>
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+20?>','bl<?=$I+20-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
			</tr>
		  </table></td>
		  <td><input type=checkbox id=lock<?=$I+20-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+20-1?>','','class1=全不中&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+20-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+20-1][2]==1){echo "checked";}?>></td>
		</tr>
	  </table>
...
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+30-1][0]?>" name="Num_<?=$I+30?>" /></td>
		  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+30?>','bl<?=$I+30-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
			</tr>
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+30?>','bl<?=$I+30-1?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
			</tr>
		  </table></td>
		  <td><input type=checkbox id=lock<?=$I+30-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+30-1?>','','class1=全不中&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+30-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+30-1][2]==1){echo "checked";}?>></td>
		</tr>
	  </table>
...
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+40-1][0]?>" name="Num_<?=$I+40?>" /></td>
		  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+40?>','bl<?=$I+39?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
			</tr>
			<tr>
			  <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+40?>','bl<?=$I+39?>','class1=全不中&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
			</tr>
		  </table></td>
		  <td><input type=checkbox id=lock<?=$I+40-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+40-1?>','','class1=全不中&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+40-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+40-1][2]==1){echo "checked";}?>></td>
		</tr>
	  </table>
	  ...
	  <? }else{?>
		  <td width="88" align="center" colspan="2"><input type="submit"   class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" name="Submit2" value="提交" /></td>
		  <td width="88" align="center" colspan="2"><input type="reset"    class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" name="Submit3" value="重置" /></td>
	  <? }?>
	</tr>
	<? }?>
...
<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
  <form action="index.php?action=rake_wbz&savew=savew&ids=<?=$ids?>" name="form21" method="post" >
	<tr align="middle">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <form action="index.php?action=rake_wbz&save=save&ids=<?=$ids?>" name="form21" method="post" ><tr>
