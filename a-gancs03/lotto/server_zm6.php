...
while ($rs = $result->fetch()){
	...
	if (($sum_tm[$ii] == '大') || ($sum_tm[$ii] == '小')){
		...
		$z_xx_dx += $Rs5['sum_m3'];
		$z_pz_dx += $Rs7['sum_m3'];
	}else if (($sum_tm[$ii] == '单') || ($sum_tm[$ii] == '双')){
		$z_re_ds += $Rs5['re'];
		$z_sum_ds += $Rs5['sum_m'];
		...
		$z_xx_ds += $Rs5['sum_m3'];
		$z_pz_ds += $Rs7['sum_m3'];
	}else if (($sum_tm[$ii] == '红波') || ($sum_tm[$ii] == '绿波') || ($sum_tm[$ii] == '蓝波')){
		$z_re_bs += $Rs5['re'];
		$z_sum_bs += $Rs5['sum_m'];
		...
		$z_xx_bs += $Rs5['sum_m3'];
		$z_pz_bs += $Rs7['sum_m3'];
	}else if (($sum_tm[$ii] == '合大') || ($sum_tm[$ii] == '合小')){
		$z_re_hdx += $Rs5['re'];
		$z_sum_hdx += $Rs5['sum_m'];
		...
		$z_xx_hdx += $Rs5['sum_m3'];
		$z_pz_hdx += $Rs7['sum_m3'];
	}else if (($sum_tm[$ii] == '合单') || ($sum_tm[$ii] == '合双')){
		$z_re_hds += $Rs5['re'];
		$z_sum_hds += $Rs5['sum_m'];
		...
		$z_xx_hds += $Rs5['sum_m3'];
		$z_pz_hds += $Rs7['sum_m3'];
	}else if (($sum_tm[$ii] == '尾大') || ($sum_tm[$ii] == '尾小')){
		$z_re_wdx += $Rs5['re'];
		$z_sum_wdx += $Rs5['sum_m'];
