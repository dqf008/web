...
<form id="myFORM" name="FrmData"  action="index.php?action=re_all" method="post"> 
  ...
  <tr> 
	...
	<td bordercolor="cccccc" ><table cellspacing="0" cellpadding="0" border="0"> 
	  <tbody> 
		 <tr>
            <td><input name="txt8" type="text" class="input1" value="<?=date("Y-m-d")?>" onClick="new Calendar(2008,2020).show(this);" size="12" />
            </td>
           
            <td align="middle" width="20">~</td>
            <td><input name="txt9" type="text" class="input1" value="<?=date("Y-m-d")?>" onClick="new Calendar(2008,2020).show(this);" size="12" />
            </td>
