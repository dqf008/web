...
$keym = md5($keyon);
$Current_Kithe_Num = 1;
$Current_KitheTable = $mydata2_db->query("\r\n\t" . 'Select id,nn,nd,na,n1,n2,n3,n4,n5,n6,lx,kitm,kitm1,kizt,kizt1,kizm,kizm1,kizm6,kizm61,' . "\r\n\t" . 'kigg,kigg1,kilm,kilm1,kisx,kisx1,kibb,kibb1,kiws,kiws1,zfb,zfbdate,zfbdate1,best ' . "\r\n\t" . 'From ka_kithe' . "\r\n\t" . 'where na=0 Order By id Desc LIMIT 1')->fetch();
$nodata = 0;
if ($Current_KitheTable[0] == '')
{
	$nodata = 1;
	//echo '<script>alert("注意!当前没有任何期数，请先添加一个，免得出错！");</script>';
}
