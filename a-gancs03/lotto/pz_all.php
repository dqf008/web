...
if ($_GET['zsave'] == 'zsave'){
	...
	$params = array(':tm' => $_POST['tm'], ':tm1' => $_POST['tm1']);
...
if ($_GET['save'] == 'save'){
	echo "<script>alert('系统已关闭补仓功能!');window.location.href='index.php?action=pz_all&kithe=".$kithe."';</script>";
	exit();
}
?>
...
<form action="index.php?action=pz_all&save=save&ids=<?=$ids;?>&kithe=<?=$kithe;?>"    method="post" name="form1" ><?php include 'd1.php';?></form> 
</div> 
