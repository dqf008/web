...
if ($_GET['zsave'] == 'zsave'){
	...
	$params = array(':lm' => $_POST['tm'], ':lm1' => $_POST['tm1']);
	$stmt = $mydata2_db->prepare('update adad set lm=:lm,lm1=:lm1  Where id=1');
	$stmt->execute($params);
}
...
if ($_GET['save'] == 'save'){
	echo "<script>alert('系统已关闭补仓功能!');window.location.href='index.php?action=pz_wbz&ids=".$ids."&kithe=".$kithe."';</script>";
	exit();
}
?>
...
var mm8=mm8+"<a href=index.php?action=pz_wbz&ids=<?=$ids;?>&kithe=<?=$kithe;?>&page="+bb+"><strong>第"+bbb+"页</strong></a>&nbsp;&nbsp;&nbsp;" 
bb++ 
bbb++ 
} 
...
if (i!=(arrResult.length-2)){ 
var zmzm1="index.php?action=look&kithe=<?=$kithe;?>&class2=<?=$ids;?>&lx=0&id=12&class3="+arrTmp[12];
...
var zmzm2="index.php?action=look&lx=1&kithe=<?=$kithe;?>&class2=<?=$ids;?>&id=12&class3="+arrTmp[12];
...
{ 
  ...
  { 
   ...
   makeRequest('index.php?action=server_wbz&class1=全不中&class2=<?=$ids;?>&class3=<?=$c1;?>&kithe=<?=$kithe;?>') 
...
<tr class="tbtitle"> 
 ...
 <tr align="right"> 
  <td> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=五不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color;?>;'>五不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=六不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>六不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=七不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>七不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=八不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>八不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=九不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>九不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=十不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>十不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=十一不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>十一不中</span></button> 
	  <button type="button" onClick="javascript:location.href='index.php?action=pz_wbz&ids=十二不中&kithe=<?=$kithe;?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>十二不中</span></button> 
  </td> 
</tr> 
<tr > 
  <td height="5"></td> 
...
while ($image = $result->fetch()){
	echo "<OPTION value=index.php?action=pz_wbz&ids=".$ids."&kithe=".$image['nn'];
	if ($kithe!="") {
		if ($kithe==$image['nn']) {
	...
	echo ">第".$image['nn']."期</OPTION>";
	  ...
	  <form name=form55 action="index.php?action=pz_wbz&zsave=zsave&kithe=<?=$kithe;?>&ids=<?=$ids;?>" method=post> 
		...
		<td width="81"><button type="button" onClick="submit()"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:80;height:22" ><img src="images/icon_21x21_copy.gif" align="absmiddle" />确认修改</button></td> 
	  </form> 
	  <td width="494"><input name="lm" type="hidden" id="lm" value="0"></td> 
	</tr> 
  </table></td> 
</tr> 
</table> 
...
<form action="index.php?action=pz_wbz&save=save&ids=<?=$ids;?>&kithe=<?=$kithe;?>"    method="post" name="form1" ><?php include 'd1.php';?></form> 
</div> 
...
<SCRIPT language=javascript> 
makeRequest('index.php?action=server_wbz&class1=全不中&class2=<?=$ids;?>&class3=<?=$c1;?>&kithe=<?=$kithe;?>')</script>
    <script language="JavaScript">
        function get_member_bet(obj){
            ...
            if(amount > 0){
                ...
                window.open("member_bet_list.php?six_num="+num+"&qishu="+qishu+"&class1=全不中",'newwindow', 'height=500, width=800, top=100, left=250, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');
            }
        }
