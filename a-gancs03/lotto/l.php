...
?> 			
			...
			<tr bgColor="#FFFFF4" onMouseOver="javascript:this.bgColor='ffffff'" onMouseOut="javascript:this.bgColor='#FFFFF4'">
			  ...
			  <td align="center" nowrap ><a href="index.php?action=list&kithe=<?=$rs['nn'];?>"><b><?=substr($rs['nd'],0,10)?><? echo  "星期".$d[date("w",strtotime($rs['nd']))]; ?></b></A></td>
			  <td align="center" ><font color=ff0000><?=$rs['nn'];?>期</font></td>
			  <td align="center" nowrap="nowrap" ><b><font color=ff0000><A  href="index.php?action=list&kithe=<?=$rs['nn'];?>"><?=$Rs5['sum_m'];?></A></font></b></td>
...
<?php }
			  ...
			  <td align="center" nowrap="nowrap"><span class="STYLE4"><?=$z_usersf;?></span></td>
			</tr>
		  </form>
	</table>
