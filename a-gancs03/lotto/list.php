	  ...
	  <form target="mem_order" name="lt_form"  method="post" action="n1.asp?class2=<?=ids?>">  
		<tr class="tbtitle"> 
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0"> 
			...
			<td >
			<div align="right">  		  
				<button type="button" onClick="javascript:location.href='index.php?action=l';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff6600;'>返回</span></button> 
...
$result = $mydata2_db->prepare('select *  from   ka_tan where  kithe=:kithe order by id desc');
...
<?php }?> 			     
		<tr class="tbtitle"> 
		  ...
		  <td height="28" align="center" nowrap="nowrap" ><span class="STYLE4">共下注《<?=$z_re;?>注》</span></td> 
		  <td align="center" nowrap="nowrap" >&nbsp;</td> 
		  ...
		  <td align="center" nowrap="nowrap"><span class="STYLE4"><?=$z_user;?></span></td> 
		</tr> 
	  </form> 
</table> 
