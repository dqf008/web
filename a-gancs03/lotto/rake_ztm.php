...
if ($_GET['save'] == 'save'){
	...
	for ($tt = 1;$tt <= 49;$tt++){
		if ($_POST['dx'] == '全部'){
			...
			$params = array(':adddate' => $text, ':rate' => $_POST['bl'], ':blrate' => $_POST['bl'], ':class2' => $ids, ':class3' => $tt);
			$stmt = $mydata2_db->prepare('update ka_bl set adddate=:adddate,rate=:rate,blrate=:blrate where class2=:class2 and  class3=:class3');
			$stmt->execute($params);
		}
		...
		if ($_POST['dx'] == '单'){
			if ($tt % 2 == 1)
			{
				$params = array(':rate' => $_POST['bl'], ':blrate' => $_POST['bl'], ':class2' => $ids, ':class3' => $tt);
				$stmt = $mydata2_db->prepare('update ka_bl set rate=:rate,blrate=:blrate where class2=:class2 and  class3=:class3');
				$stmt->execute($params);
			}
		}
...
if ($_GET['act'] == '修改'){
	...
	for ($tt = 1;$tt <= 60;$tt++){
		...
		$params = array(':rate' => $num, ':blrate' => $num, ':class2' => $ids, ':class3' => $class3);
		$stmt = $mydata2_db->prepare('update ka_bl set rate=:rate,blrate=:blrate where class2=:class2 and  class3=:class3');
		$stmt->execute($params);
		if (49 < $tt){
			$params = array(':rate' => $num, ':blrate' => $num, ':class2' => $class22, ':class3' => $class3);
			$stmt = $mydata2_db->prepare('update ka_bl  set rate=:rate,blrate=:blrate where class1=\'过关\' and  class2=:class2 and  class3=:class3');
			$stmt->execute($params);
		}
	}
	
	echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_ztm&ids=".$ids."';</script>";
	exit();
}

if ($_GET['savew'] == 'savew'){
	if (empty($_POST['mf'])){
		echo "<script>alert('请选择项目!');history.back();</script>";
		exit();
	}
	
	if (empty($_POST['money'])){
		echo "<script>alert('请输入数值!');history.back();</script>";
		exit();
	}
	...
	for ($f = 0;$f < $ss4;$f++){
		if ($mv == 0){
			...
			$stmt = $mydata2_db->prepare('update ka_bl set rate=rate-:rate where class1=\'正特\'  and   class3=:class3');
			$stmt->execute($params);
		}else{
			$params = array(':rate' => $money, ':class3' => $pc4[$f]);
			$stmt = $mydata2_db->prepare('update ka_bl set rate=rate+:rate where class1=\'正特\'  and   class3=:class3');
...
$result = $mydata2_db->prepare('Select rate,class3,locked,id from ka_bl where class1=\'正特\'    and class2=:class2 Order By ID  LIMIT 60');
...
<link rel="stylesheet" href="xp.css" type="text/css"> 
  <table width="100%" border="0" cellspacing="0" cellpadding="5"> 
	...
	<table width="99%"   border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="f1f1f1" bordercolordark="#FFFFFF" bgcolor="ffffff"> 
	<form name="form1" method="post" action="index.php?action=rake_ztm&act=修改&ids=<?=$ids;?>">  
	  <tr > 
		<td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0"> 
		  <tr> 
			<td><font color="#FFFFFF"> 
			<strong><?=$ids;?>赔率设置</strong></font></td> 
			<td><div align="right"> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_ztm&ids=正1特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color;?>;'>正1特</span></button>
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_ztm&ids=正2特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>正2特</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_ztm&ids=正3特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z3color;?>;'>正3特</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_ztm&ids=正4特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z4color;?>;'>正4特</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_ztm&ids=正5特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z5color;?>;'>正5特</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_ztm&ids=正6特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z6color;?>;'>正6特</span></button> 
			</div></td> 
		  </tr> 
	  </table></td> 
	  </tr> 
	...
	<td height="25" align="center" bordercolor="cccccc" class="ball_<?=Get_bs_Color(intval($I))?>">
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I-1][0]?>" name="Num_<?=$I?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I?>','bl<?=$I-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?=$ShowTable[$I-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I?>','bl<?=$I-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?=$ShowTable[$I-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I-1?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I-1][1]?>&lock='+this.checked);" value="TRUE"  <? if ($ShowTable[$I-1][2]==1){echo "checked";}?>>
                  </input></td>
                </tr>
              </table>
			 ...
			 <img src="images/num<?=$I+10?>.gif" /></td>
              <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+10?>','bl<?=$I+10-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?=$ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+10?>','bl<?=$I+10-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?=$ShowTable[$I+10-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+10-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+10-1?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+10-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+10-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+20-1][0]?>" name="Num_<?=$I+20?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+20?>','bl<?=$I+20-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?=$ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+20?>','bl<?=$I+20-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?=$ShowTable[$I+20-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+20-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+20-1?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+20-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+20-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+30-1][0]?>" name="Num_<?=$I+30?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+30?>','bl<?=$I+30-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?=$ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+30?>','bl<?=$I+30-1?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?=$ShowTable[$I+30-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+30-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+30-1?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+30-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+30-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+40-1][0]?>" name="Num_<?=$I+40?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+40?>','bl<?=$I+39?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.1&class3=<?=$ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+40?>','bl<?=$I+39?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.1&class3=<?=$ShowTable[$I+40-1][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+40-1?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+40-1?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+40-1][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+40-1][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
...
?><tr>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+48][0]?>" name="Num_<?=$I+49?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+49?>','bl<?=$I+48?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+48][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+49?>','bl<?=$I+48?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+48][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+48?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+48?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+48][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+48][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+50][0]?>" name="Num_<?=$I+51?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+51?>','bl<?=$I+50?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+50][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+51?>','bl<?=$I+50?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+50][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+50?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+50?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+50][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+50][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+52][0]?>" name="Num_<?=$I+53?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+53?>','bl<?=$I+52?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+52][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+53?>','bl<?=$I+52?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+52][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+52?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+52?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+52][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+52][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+54][0]?>" name="Num_<?=$I+55?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+55?>','bl<?=$I+54?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+54][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+55?>','bl<?=$I+54?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+54][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+54?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+54?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+54][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+54][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+56][0]?>" name="Num_<?=$I+57?>" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+57?>','bl<?=$I+56?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I+56][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_<?=$I+57?>','bl<?=$I+56?>','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I+56][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock<?=$I+56?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I+56?>','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I+56][1]?>&lock='+this.checked);"  <? if ($ShowTable[$I+56][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
			...
			<tr>
                ...
                <tr>
                  <td><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[58][0]?>" name="Num_59" /></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_59','bl58','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[58][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_59','bl58','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[58][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  <td><input type=checkbox id=lock58 style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock58','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[58][1]?>&lock='+this.checked);"  <? if ($ShowTable[58][2]==1){echo "checked";}?>></td>
                </tr>
              </table>
              <input name="class3_59" value="<?=$ShowTable[58][1]?>" type="hidden" ></td>
			     <td height="25" align="center" bordercolor="cccccc"><span id=bl58><?=$ShowTable[58][0]?></span></td>
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td><input 
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[59][0]?>" name="Num_60" /></td>
                     <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr>
                           <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_60','bl59','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[59][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                         </tr>
                         <tr>
                           <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','Num_60','bl59','class1=正特&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[59][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                         </tr>
                     </table></td>
                     <td><input name="checkbox" type=checkbox id=checkbox style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock59','','class1=正特&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[59][1]?>&lock='+this.checked);"  <? if ($ShowTable[59][2]==1){echo "checked";}?>></td>
                   </tr>
                 </table>
		         <input name="class3_60" value="<?=$ShowTable[59][1]?>" type="hidden" ></td>
			     <td height="25" align="center" bordercolor="cccccc"><?=$ShowTable[59][0]?></td>
			     <td align="center" bordercolor="cccccc"><span id=gold59>0</span></td>
			     <td height="25" align="center" bordercolor="cccccc">&nbsp;</td>
			     <td height="25" align="center" bordercolor="cccccc">&nbsp;</td>
			     <td height="25" align="center" bordercolor="cccccc">&nbsp;</td>
			     <td align="center" bordercolor="cccccc">&nbsp;</td>
	...
	<table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1">
          <form action="index.php?action=rake_ztm&savew=savew&ids=<?=$ids?>" name="form21" method="post" >
            <tr align="middle">
            ...
            <tr align="middle">
              ...
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?=show_xxsx222(21)?>">
                <strong>蓝单</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?=show_xxsx222(22)?>">
                <strong>蓝双</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?=show_xxsx222(23)?>">
                <strong>蓝大</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE4">
              <input name="mf[]" type="checkbox" id="mf[]" value="<?=show_xxsx222(24)?>">
                <strong>蓝小</strong></span></td>
              <td align="left" nowrap bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE5">
   ...
   <form action="index.php?action=rake_ztm&save=save&ids=<?=$ids?>" name="form21" method="post" ><tr>
...
<SCRIPT language=javascript> 
makeRequest('index.php?action=server&class1=正特&class2=<?=$ids;?>')</script>
<?php 
