...
if ($_GET['act'] == '修改'){
	...
	for ($tt = 1;$tt <= 8;$tt++){
		...
		$stmt = $mydata2_db->prepare('update ka_bl  set adddate=:adddate,rate=:rate where class1=\'连码\' and class2=:class2 and  class3=:class3');
		$stmt->execute($params);
	}
...
$result = $mydata2_db->query('Select rate,class3,class2 from ka_bl where class1=\'连码\'   Order By ID');
$ShowTable = array();
$y = 0;
