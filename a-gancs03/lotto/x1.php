...
<tr class="tbtitle"> 
  <td width="15%"><strong><font color="#FFFFFF">注单查询[<?=$kithe;?>期]</font></strong></td> 
  ...
  <td width="37%" align="right"><button type="button" onClick="javascript:window.print();"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:80;height:22" ><img src="images/asp.gif" width="16" height="12" align="absmiddle" />打印</button></td> 
</tr> 
<tr > 
...
<tr > 
  ...
  <TD align="center" bordercolor="cccccc" bgcolor="#FDF4CA" >股东</TD> 
...
$result = $mydata2_db->prepare('select distinct(guan)   from   ka_tan where Kithe=:Kithe  order by guan desc');
$result->execute($params);
$ii = 0;
while ($rs = $result->fetch()){
$params = array(':Kithe' => $kithe, ':guan' => $rs['guan']);
$result1 = $mydata2_db->prepare('Select sum(sum_m) as sum_m,count(*) as re,sum(sum_m*dagu_zc/10) as dagu_zc,sum(sum_m*guan_zc/10) as guan_zc,sum(sum_m*zong_zc/10) as zong_zc,sum(sum_m*dai_zc/10) as dai_zc,sum(sum_m-sum_m*user_ds/100) as sum_st from ka_tan   where Kithe=:Kithe and guan=:guan');
...
<tr > 
  <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><?=$ii?></td>
    ...
    <td align="center" nowrap="nowrap" bordercolor="cccccc">
		<button type="button" onClick="javascript:location.href='index.php?action=x2&kithe=<?=$kithe?>&username=<?=$rs['guan']?>'"  class="headtd4" style="width:80;height:22" ;><font color=ff6600><?=$Rs5['sum_m']?></font></button>
	</td>
...
<tr > 
  <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc">&nbsp;</td>
    ...
    <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE3"><?=round($z_dagu,2)?></span></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE3"><?=round($z_guan,2)?></span></td>
    <td align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE3"><?=round($z_zong,2)?></span></td>
    <td height="28" align="center" nowrap="nowrap" bordercolor="cccccc"><span class="STYLE3"><?=round($z_dai,2)?></span></td>
</tr> 
</table> 
<br> 
