...
if ($_GET['act'] == '修改'){
	...
	for ($tt = 1;$tt <= 5;$tt++){
		...
		$stmt = $mydata2_db->prepare('update ka_bl  set adddate=:adddate,mrate=:mrate where class1=\'五行\' and class2=:class2 and  class3=:class3');
		$stmt->execute($params);
	}
	
	echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_mwx&ids=". $ids ."';</script>";
	exit();
}
$result = $mydata2_db->query('Select mrate,class3,class2 from ka_bl where class1=\'五行\'   Order By ID');
$ShowTable = array();
$y = 0;
...
<form name="form1" method="post" action="index.php?action=rake_mwx&act=修改&ids=<?=$ids?>"> <TBODY>
  <TR align=center>
	<TD height=26 colSpan=4 bordercolor="cccccc" bgcolor="#FF6633" ><table width="99%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
  ...
  <TR align=center>
	...
	<TD width="233" bordercolor="cccccc" bgcolor="#FDF4CA" >
	赔率</TD>
  </TR>
<?
$bbffx=25;
...
?> 
  <TR>
	<TD width="94" align="center" bordercolor="cccccc"><?=$ShowTable[$I][2]?></TD>
	<TD width="94" align="center" bordercolor="cccccc"><?=$ShowTable[$I][1]?></TD>
	<TD width="640" align="center" bordercolor="cccccc" bgcolor="f1f1f1"><table align=left>
	  <tr>
<?						
...
for ($j = 0;$j < $ssc;$j = $j + 1){	
	...
	<TD width="233" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
	  <tr>
  ...
  <? }?>
  <TR>
	<TD colspan="4" align="center" bordercolor="cccccc"><table width="98" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
