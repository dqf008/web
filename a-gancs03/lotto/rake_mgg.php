...
if ($_GET['act'] == '修改'){
	...
	for ($tt = 1;$tt <= 42;$tt++){
		...
		$stmt = $mydata2_db->prepare('update ka_bl  set adddate=:adddate,mrate=:mrate where class1=\'过关\' and class2=:class2 and  class3=:class3');
		$stmt->execute($params);
		$params = array(':adddate' => $text, ':mrate' => $num, ':class2' => $class22, ':class3' => $class3);
		$stmt = $mydata2_db->prepare('update ka_bl  set adddate=:adddate,mrate=:mrate where class1=\'正特\' and class2=:class2  and  class3=:class3');
		$stmt->execute($params);
	}
	echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_mgg&ids=".$ids."';</script>";
	exit();
}

$result = $mydata2_db->query('Select mrate,class3,class2 from ka_bl where class1=\'过关\'   Order By ID');
$ShowTable = array();
$y = 0;
...
<form name="form1" method="post" action="index.php?action=rake_mgg&act=修改&ids=<?=$ids?>">
 <?
 ...
 for ($B=1; $B<=2; $B=$B+1)
{
 ...
 ?> 
	<tr >
	  <td height="28" colspan="6" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
		<tr>
	...
	<tr >
	  <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">正码1</td>
	  <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">正码2</td>
	  <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">正码3</td>
	</tr>
	<tr >
...
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I-1][0]?>" name="Num_<?=$I?>" />
	  ...
	  <td height="25" align="center" bordercolor="cccccc"><input      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+7-1][0]?>" name="Num_<?=$I+7?>" /> <input name="class3_<?=$I+7?>" value="<?=$ShowTable[$I+7-1][1]?>" type="hidden" ></td>
	  ...
	  <td height="25" align="center" bordercolor="cccccc"><input 
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+14-1][0]?>" name="Num_<?=$I+14?>" /><input name="class3_<?=$I+14?>" value="<?=$ShowTable[$I+14-1][1]?>" type="hidden" ></td>
	</tr>
	<? }
	}else{?>
	 ...
	 <tr>
	  <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">正码4</td>
	  <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">正码5</td>
	  <td height="28" colspan="2" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D">正码6</td>
	</tr>
	<tr>
	  <td width="4%" height="28" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA"> 号码</td>
	  <td width="4%" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FDF4CA"> 赔率</td>
...
{?>
	<tr>
	  ...
	  <td height="25" align="center" bordercolor="cccccc"><input 
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+21-1][0]?>" name="Num_<?=$I+21?>" />
	  ...
	  <td height="25" align="center" bordercolor="cccccc"><input      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+28-1][0]?>" name="Num_<?=$I+28?>" /> <input name="class3_<?=$I+28?>" value="<?=$ShowTable[$I+28-1][1]?>" type="hidden" ></td>
	  ...
	  <td height="25" align="center" bordercolor="cccccc"><input 
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[$I+35-1][0]?>" name="Num_<?=$I+35?>" /><input name="class3_<?=$I+35?>" value="<?=$ShowTable[$I+35-1][1]?>" type="hidden" ></td>
	</tr>
	 ...
	 ?>
	  <tr>
	  <td height="25" colspan="6" align="center" bordercolor="cccccc"><table width="98" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
