...
if ($_GET['act'] == '修改'){
	...
	for ($tt = 1;$tt <= 12;$tt++){
		...
		$stmt = $mydata2_db->prepare('update ka_bl  set adddate=:adddate,rate=:rate where class1=\'生肖连\' and class2=:class2 and  class3=:class3');
		$stmt->execute($params);
	}
	
	echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_sxt&ids=".$ids."';</script>";
	exit();
}

$params = array(':class2' => $class2);
$result = $mydata2_db->prepare('Select rate,class3,class2,locked,class1 from ka_bl where (class1=\'生肖连\' and class2=:class2)  Order By ID');
...
?>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="5"> 
   ...
   <tr > 
	 ...
	 <td><div align="right"> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=二肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color;?>;'>二肖连中</span></button>&nbsp;
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=三肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color;?>;'>三肖连中</span></button>&nbsp;
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=四肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>四肖连中</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=五肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>五肖连中</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=二肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>二肖连不中</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=三肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>三肖连不中</span></button> 
			  <button type="button" onClick="javascript:location.href='index.php?action=rake_sxt&ids=四肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>四肖连不中</span></button> 
			</div></td>    
   </tr> 
 </table> 
<table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
   <form name="form1" method="post" action="index.php?action=rake_sxt&act=修改&ids=<?=$ids?>"> <TBODY>
	  <TR align=center>
	 ...
	 <? for ($I=0; $I<count($ShowTable); $I=$I+1){?> 
	  ...
	  <TR>
        ...
        <SCRIPT language=javascript> 
   makeRequest('index.php?action=server&class1=生肖连&class2=<?=$ids;?>')</script> 
