...
$result = $mydata2_db->prepare('select class3,class1   from   ka_bl where class1=:class1 and class2=\'正A\'  order by id');
...
while ($rs = $result->fetch()){
	...
	$result5 = $mydata2_db->prepare('Select * from ka_bl   where   class1=:class1 and class2=\'正A\' and class3=:class3');
