...
if ($action == 'ok'){
	...
	for (;$i <= $nums;$i++)
	{
		...
		$sql = 'update c_opentime_sfssc set kaipan=:kaipan,fengpan=:fengpan,kaijiang=:kaijiang where qishu=:qishu';
		  ...
		  <td valign="top"> 
			  ...
			  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9"> 
				  <tr> 
					  ...
					  <td align="left" bgcolor="#FFFFFF">三分时时彩【<a href="Auto_sfssc.php" style="color:#ff0000;">点击进入开奖设置</a>】</td>
				  </tr> 
				  <tr> 
...
<?php 
$sql = 'select * from c_opentime_sfssc order by qishu asc';
