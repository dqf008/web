...
if ($action == 'ok'){
	...
	for (;$i <= $nums;$i++)
	{
		...
		$params = array(':kaipan' => $kaipan, ':fengpan' => $fengpan, ':kaijiang' => $kaijiang, ':qishu' => $i);
		$sql = 'update c_opentime_tjssc set kaipan=:kaipan,fengpan=:fengpan,kaijiang=:kaijiang where qishu=:qishu';
		  ...
		  <td valign="top"> 
			  ...
			  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9"> 
				  <tr> 
					  ...
					  <td align="left" bgcolor="#FFFFFF">天津时时彩【<a href="Auto_tjssc.php" style="color:#ff0000;">点击进入开奖设置</a>】</td>
				  </tr> 
				  <tr> 
				  ...
				  <tr> 
					  ...
					  <td align="left" bgcolor="#FFFFFF"> 
						  ...
						  <input name="submit" type="button" class="submit80" value="刷新" onClick="location.href='Uptime_tjssc.php'" /></td>
				  </tr> 
			  </table> 
			  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">    
...
<?php 
$sql = 'select * from c_opentime_tjssc order by qishu asc';
