...
if ($save == 'ok')
{
	if ($type == 1)
	{
		...
		$sql = 'update c_odds_4 set h1=:h1,h2=:h2,h3=:h3,h4=:h4,h5=:h5,h6=:h6,h7=:h7,h8=:h8,h9=:h9,h10=:h10,h11=:h11,h12=:h12,h13=:h13,h14=:h14,h15=:h15,h16=:h16,h17=:h17,h18=:h18,h19=:h19,h20=:h20,h21=:h21 where type=:type';
		...
		$sql = 'update c_odds_4 set h1=:h1,h2=:h2,h3=:h3,h4=:h4,h5=:h5,h6=:h6,h7=:h7,h8=:h8,h9=:h9,h10=:h10,h11=:h11,h12=:h12,h13=:h13,h14=:h14 where type=:type';
		$stmt = $mydata1_db->prepare($sql);
		$stmt->execute($params);
		echo "<script>alert(\"赔率修改完毕！\");window.open('odds4.php?type=".$type."','mainFrame');</script>";
		exit();
		...
		$sql = 'update c_odds_4 set h1=:h1,h2=:h2 where type=:type';
		$stmt = $mydata1_db->prepare($sql);
		$stmt->execute($params);
		echo "<script>alert(\"赔率修改完毕！\");window.open('odds4.php?type=".$type."','mainFrame');</script>";
		exit();
...
//读取当前期数盘口赔率与投注总额 
function loadinfo(){ 
  $.post("get_odds_4.php", {type :<?=$type;?>}, function(data) 
	  { 
...
function UpdateRate(num ,i){ 
  $.post("updaterate_4.php", {type :<?=$type;?>,num : num ,i : i}, function(data) 
	  { 
