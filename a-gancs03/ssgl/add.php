...
if ($_GET['action'] == 'add'){
	...
	$params = array(':match_name' => $match_name, ':x_title' => $x_title, ':match_date' => $match_date, ':match_time' => $match_time, ':match_coverdate' => $match_coverdate, ':match_id' => $match_id);
	$sql = 'insert into mydata4_db.t_guanjun(match_name,x_title,match_date,match_time,match_coverdate,match_id) values(:match_name,:x_title,:match_date,:match_time,:match_coverdate,:match_id)';
...
<tr> 
  ...
  <td width="473"><input type="text"  name="match_date" id="match_date" value=" m-d " /> 
	格式为：08-30</td> 
</tr> 
<tr> 
  <td bgcolor="#F0FFFF">结束时间</td> 
  <td><input type="text"  name="match_time" id="match_time" value=" h:i a" />  
	格式为：11:00a</td> 
</tr> 
  <tr> 
  <td bgcolor="#F0FFFF">封盘时间</td> 
  <td><input type="text"  name="match_coverdate" id="match_coverdate" value=" Y-m-d H:i:s " />  
