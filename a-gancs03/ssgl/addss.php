...
if ($_GET['action'] == 'add'){
	...
	$params = array(':match_name' => $match_name, ':match_master' => $match_master, ':match_guest' => $match_guest, ':match_id' => $match_id, ':match_date' => $match_date, ':match_time' => $match_time, ':match_coverdate' => $match_coverdate);
	$sql = 'insert into mydata4_db.' . $table . ' (match_name,match_master,match_guest,match_id,match_date,match_time,match_coverdate) values (:match_name,:match_master,:match_guest,:match_id,:match_date,:match_time,:match_coverdate)';
