...
$page_date = $date;
$sql = 'SELECT Match_ID,Match_Date, Match_Time, Match_Master, Match_Guest, Match_Name, Match_IsLose,Match_BzM, Match_BzG, Match_BzH , Match_MasterID, Match_GuestID FROM mydata4_db.baseball_Match ';
...
$sql .= $sqlwhere;
$match_name = getmatch_name('baseball_Match', $sqlwhere, $params);
	...
	<td width="119">类型： 
	 ...
	 foreach ($match_name as $k=>$v){?>
  	 ...
  	 <? }?>
		...
		<td width="179"><A href="baseball_danshi.php?match_type=<?=$match_type?>">单式</A>&nbsp;&nbsp;<a href="baseball_zdf.php?match_type=<?=$match_type?>">总得分</a>
	</td> 
  </tr> 
</table> 
<table width="785" border="0" cellpadding="0" cellspacing="1"  bgcolor="006255" class="m_tab" id="glist_table"> 
  <tr class="m_title_ft"> 
  <td width="60" height="24">时间</td> 
	<td nowrap="nowrap" width="160">联盟</td> 
	<td width="60">场次</td> 
	<td width="300">队伍</td> 
	<td width="119"><span style="width:121px;">独赢</span></td> 
	<td width="79">总得分</td> 
  </tr>
  <?php
