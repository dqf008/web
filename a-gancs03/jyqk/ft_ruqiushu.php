...
if ($match_type == 1){
	...
	$sqlwhere = ' where Match_Type =1 and Match_IsShowt=1 and Match_Total01Pl>0 AND Match_Date=:Match_Date ';
	...
	if (isset($_GET['date'])){
		...
		$sqlwhere = ' where Match_Type=0 and Match_IsShowt=1 AND  match_date =:Match_Date and Match_Total01Pl>0';
	}
}
$sql .= $sqlwhere;
