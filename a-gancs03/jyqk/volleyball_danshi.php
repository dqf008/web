...
$page_date = $date;
$sql = 'SELECT Match_ID,Match_Date, Match_Time, Match_Master, Match_Guest, Match_RGG, Match_Name, Match_IsLose, Match_BzM, Match_BzG, Match_DxDpl, Match_DxXpl, Match_DxGG, Match_Ho, Match_Ao, Match_MasterID, Match_GuestID,  Match_DsDpl, Match_DsSpl FROM mydata4_db.volleyball_match ';
...
$sql .= $sqlwhere;
$match_name = getmatch_name('volleyball_match', $sqlwhere, $params);
  ...
  <tr style="width:150px;"> 
	...
	<td width="119">类型： 
	 ...
	 foreach ($match_name as $k=>$v){?>
		...
		<td width="179"><A href="volleyball_danshi.php?match_type=<?=$match_type?>">单式</A>&nbsp;&nbsp;<a href="volleyball_bodan.php?match_type=<?=$match_type?>">波胆</a> 
	</td> 
  </tr> 
</table> 
