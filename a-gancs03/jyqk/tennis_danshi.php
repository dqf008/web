...
$page_date = $date;
$sql = 'SELECT Match_ID,Match_Date, Match_Time, Match_Master, Match_Guest, Match_RGG, Match_Name, Match_IsLose, Match_BzM, Match_BzG, Match_DxDpl, Match_DxXpl, Match_DxGG, Match_Ho, Match_Ao, Match_MasterID, Match_GuestID,  Match_DsDpl, Match_DsSpl FROM mydata4_db.tennis_Match ';
...
$sql .= $sqlwhere;
$match_name = getmatch_name('tennis_Match', $sqlwhere, $params);
  ...
  <? }?>
	...
	<? }?>&nbsp;&nbsp;<a href="javascript:re_load();">刷新</a></td>
	 ...
	 foreach ($match_name as $k=>$v){?>
		...
		<td width="179"><A href="tennis_danshi.php?match_type=<?=$match_type?>">单式</A>&nbsp;&nbsp;<a href="tennis_bodan.php?match_type=<?=$match_type?>">波胆</a>
	</td> 
  </tr> 
</table> 
<table width="998" border="0" cellpadding="0" cellspacing="1"  bgcolor="006255" class="m_tab" id="glist_table"> 
  ...
  <td width="60" height="24"><strong>时间</strong></td> 
	...
	<td width="159"><strong>队伍</strong></td> 
