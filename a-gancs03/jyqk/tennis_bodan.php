...
$page_date = $date;
$sql = 'SELECT Match_ID, Match_Date, Match_Time, Match_Master, Match_Guest,Match_MasterID, Match_GuestID,Match_Name FROM mydata4_db.tennis_Match';
isset($_GET['match_type']) ? $match_type = intval($_GET['match_type']) : $match_type = 1;
$params = array();
$params[':Match_Date'] = date('m-d');
$sqlwhere = ' where match_date=:Match_Date and Match_Bd21>0 ';
if (isset($_GET['date']))
{
