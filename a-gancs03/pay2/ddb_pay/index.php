...
if(!empty($_GET['save'])){
    ...
    $str = str_replace("{{pay_pubKey}}", $_POST['pubkey'], $str);
...
<div id="app">
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="多得宝公钥" prop="pubkey">
    ...
    new Vue({
        data: {
            ...
            rules: {
              ...
              pubkey: [
                { required: true, message: '请输入多得宝公钥', trigger: 'blur' }
              ],
              url: [
