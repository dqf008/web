...
if ($q1 == 1 || $id > 0){
	...
	$group .= '$pk_db[\'提款次数\']='.$tk_num.';'."\r\n";
	if (@!chmod('../../cache', 511))
	{
		message('缓存文件写入失败！请先设 /cache 文件权限为：0777');
	}
	if (!write_file('../../cache/group_'.$id.'.php', $group.'?>'))
	{
