...
$params = array(':match_id' => $t['match_id']);
$sql = 'select MB_Inball,TG_Inball from k_bet where MB_Inball is not null and match_id=:match_id limit 1';
$stmt = $mydata1_db->prepare($sql);
$stmt->execute($params);
$m = $stmt->fetch();
...
<table width="400"  border="1" align="center" cellpadding="4" cellspacing="0" bgcolor="#E8DCC4"> 
	...
	<tr align="center"> 
	  <td colspan="2">
		 ...
		 <input type="button" onclick="javascript:thisclose();" value="关闭" />
	  </td> 
	</tr> 
</table> 
</form> 
