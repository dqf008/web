...
!in_array($type, array('1', '2', '3', '4', '5'))&&$type = '1';
...
if($action=='save'){
    ...
    $stmt->execute(array(':type' => 'JSSSC', ':class' => $type));
    if($rows = $stmt->fetch()){
            ...
            <tr>
                <td valign="top">
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9">
                        ...
                        <tr>
                            <td align="center" bgcolor="#FFFFFF" style="color:#000"><a href="?type=1" class="<?php echo $type=='1'?'sub_curr':'sub_com'; ?>">第一球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="?type=2" class="<?php echo $type=='2'?'sub_curr':'sub_com'; ?>">第二球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="?type=3" class="<?php echo $type=='3'?'sub_curr':'sub_com'; ?>">第三球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="?type=4" class="<?php echo $type=='4'?'sub_curr':'sub_com'; ?>">第四球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="?type=5" class="<?php echo $type=='5'?'sub_curr':'sub_com'; ?>">第五球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="lottery_jsssc_oddsqt.php" class="sub_com">其它选项</a></td>
                        </tr>
                    </table>
