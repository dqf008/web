...
if ($action == 'save') {
    ...
    $stmt->execute([':type' => 'SFK3', ':class' => $type]);
    if ($rows = $stmt->fetch()) {
        ...
        admin::insert_log($_SESSION['adminid'], '修改[超级快3]赔率信息');
    }
                ...
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12"
                    ...
                    <tr>
                        <td align="center" bgcolor="#3C4D82" style="color:#FFF">
                            ...
                            <a id="ssc05" href="lottery_sfk3_odds.php" class="menu_curr">超级快3</a>&nbsp;&nbsp;-&nbsp;&nbsp;
                            <a id="ssc06" href="lottery_wfk3_odds.php" class="menu_com">好运快3</a>
                        </td>
                    </tr>
                </table>
                <table border="0" align="center" cellspacing="1" cellpadding="6" width="100%" class="font12"
                    ...
                    $stmt->execute([':type' => 'SFK3', ':class' => 1]);
                    $i = 2;
                    if ($rows = $stmt->fetch()) {
                        $rows['value'] = unserialize($rows['value']);
