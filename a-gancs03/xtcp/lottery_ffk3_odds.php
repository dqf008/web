...
if ($action == 'save') {
    ...
    $stmt->execute([':type' => 'FFK3', ':class' => $type]);
    if ($rows = $stmt->fetch()) {
        ...
        admin::insert_log($_SESSION['adminid'], '修改[分分快3]赔率信息');
    }
                ...
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12"
                    ...
                    <tr>
                        <td align="center" bgcolor="#3C4D82" style="color:#FFF">
                            ...
                            <a id="ssc04" href="lottery_ffk3_odds.php" class="menu_curr">分分快3</a>&nbsp;&nbsp;-&nbsp;&nbsp;
                            <a id="ssc05" href="lottery_sfk3_odds.php" class="menu_com">超级快3</a>&nbsp;&nbsp;-&nbsp;&nbsp;
                            <a id="ssc06" href="lottery_wfk3_odds.php" class="menu_com">好运快3</a></td>
                    </tr>
                </table>
