...
if($action=='save'){
    ...
    foreach($data as $id=>$val){
        ...
        if($id>0&&is_array($val)){
            ...
            $stmt->execute(array(':type' => 'JSSSC', ':id' => $id));
            if($rows = $stmt->fetch()){
    ...
    admin::insert_log($_SESSION['adminid'], '修改[极速时时彩]赔率信息');
                    ...
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9">
                        <tr>
                            <td align="center" bgcolor="#3C4D82" style="color:#FFF">
                                ...
                                <a id="ssc02" href="lottery_jsssc_odds.php" class="menu_curr">极速时时彩</a>&nbsp;&nbsp;-&nbsp;&nbsp;
                        ...
                        <tr>
                            <td align="center" bgcolor="#FFFFFF" style="color:#000"><a href="lottery_jsssc_odds.php?type=1" class="sub_com">第一球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="lottery_jsssc_odds.php?type=2" class="sub_com">第二球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="lottery_jsssc_odds.php?type=3" class="sub_com">第三球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="lottery_jsssc_odds.php?type=4" class="sub_com">第四球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="lottery_jsssc_odds.php?type=5" class="sub_com">第五球</a>&nbsp;&nbsp;-&nbsp;&nbsp;<a href="lottery_jsssc_oddsqt.php" class="sub_curr">其它选项</a></td>
                        </tr>
                    </table>
...
$stmt = $mydata1_db->prepare('SELECT `id`, `class`, `value` FROM `c_odds_data` WHERE `type`=:type AND `class` BETWEEN 6 AND 9 ORDER BY `id` ASC');
$stmt->execute(array(':type' => 'JSSSC'));
