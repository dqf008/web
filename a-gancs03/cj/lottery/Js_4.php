...
$sql = 'select * from c_auto_4 where qishu=:qishu order by id desc limit 1';
...
$sqlMain = 'select * from c_bet_3 where type=\'北京赛车PK拾\' and js=0 and qishu=:qishu order by addtime asc';
...
if ($_GET['t'] == 1)
{?> <script>window.location.href='../../Lottery/auto_4.php';</script><?php }
