...
$sql = 'select * from c_auto_2 where qishu=:qishu order by id desc limit 1';
...
$sqlMain = 'select * from c_bet where type=\'重庆时时彩\' and js=0 and qishu=:qishu order by addtime asc';
...
if ($_GET['t'] == 1)
{?> <script>window.location.href='../../Lottery/auto_2.php?lottery_type=<?php echo $lotteryType?>';</script><?php }
