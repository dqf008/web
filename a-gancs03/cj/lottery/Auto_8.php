...
if ($apiflag == 'ok')
{
	try
	{
		...
		$sql = 'select count(*) from c_auto_8 where qishu=:qishu order by id asc limit 0,1';
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
    <tr>  
      <td align="left"> 
        ...
        幸运飞艇(<?=$qishu;?>期<?=$ball_1 ;?>,<?=$ball_2 ;?>,<?=$ball_3 ;?>,<?=$ball_4 ;?>,<?=$ball_5 ;?>,<?=$ball_6 ;?>,<?=$ball_7 ;?>,<?=$ball_8 ;?>,<?=$ball_9 ;?>,<?=$ball_10;?>): 
        <span id="timeinfo"></span> 
        </td> 
    </tr> 
  </table><?php if ($okflag == 1)
{?> <iframe src="js_8.php?qi=<?=$qishu;?>" frameborder="0" scrolling="no" height="0" width="0"></iframe><?php }?> </body> 
