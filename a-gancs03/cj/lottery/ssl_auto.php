...
$mysql = 'select * from lottery_k_ssl where qihao=:qihao';
...
$sqlMain = 'select * from lottery_data where atype=\'ssl\' and mid=:qihao and bet_ok=0 order by ID asc';
