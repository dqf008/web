...
function theif_data($site, $uid, $gtype, $rtype, $langx, $page_no)
{
	switch ($gtype)
	{
		case 'FU': $base_url = $site . '/app/member/FT_future/index.php?rtype=' . $rtype . '&uid=' . $uid . '&langx=' . $langx . '&mtype=3';
		$filename = $site . '/app/member/FT_future/body_var.php?rtype=' . $rtype . '&uid=' . $uid . '&langx=' . $langx . '&mtype=3&page_no=' . $page_no;
		break;
		case 'FS': $base_url = $site . '/app/member/browse_FS/loadgame_R.php?rtype=fs&uid=' . $uid . '&langx=' . $langx . '&mtype=3';
		...
		break;
		case 'OU': $gtype_browse = $gtype . '_browse';
		...
		break;
		case 'BKR': $base_url = $site . '/app/member/BK_future/index.php?rtype=' . $rtype . '&uid=' . $uid . '&langx=' . $langx . '&mtype=3';
		$filename = $site . '/app/member/BK_future/body_var.php?rtype=' . $rtype . '&uid=' . $uid . '&langx=' . $langx . '&mtype=3&page_no=' . $page_no;
		break;
		default: $gtype_browse = $gtype . '_browse';
	...
	$a = array('if(self == top)', '<script>', '</script>', 'parent.GameFT=new Array();', 'new Array(\'gid\'', "\n\n");
	$b = array('', '', '', '', '', '');
	unset($matches);
