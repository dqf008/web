...
check_quanxian('xxgl');
$params = array(':msg_id' => intval($_GET['id']));
$sql = 'select k.*,u.username from k_user_msg k,k_user u where k.uid=u.uid and msg_id=:msg_id';
...
<table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse;color: #225d9c;" id=editProduct   idth="100%" > 
		  ...
		  <tr align="center"> 
			<td>&nbsp;</td> 
			<td align="left"><a href="javascript:void(0);" onClick="javascript:history.back();">返回上一页</a></td> 
	  </tr> 
  </table> 
  </td> 
</tr> 
