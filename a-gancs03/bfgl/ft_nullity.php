...
<table   border="0" cellspacing="1" cellpadding="0"  bgcolor="006255" width="900" height="41"> 
  ...
  <?php 
	...
	?>      <tr class="m_cen"<?=$color?> align="center" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#ffffff'"> 
				<td  align="center" ><a href="../zdgl/<?=$ds_php?>?tf_id=<?=$rows['number']?>" target="_blank"><?=$rows['number']?></a><br/><a href="../zdgl/<?=$ds_php?>?match_id=<?=$rows['match_id']?>" target="_blank"><?=$rows['match_id']?></a><br/><?=$rows['match_name']?> </td> 
				<td>
				<?php
				if(strpos($rows["master_guest"],'VS.')){ echo str_replace("VS.","<br/>",$rows["master_guest"]);}else{  echo str_replace("VS","<br/>",$rows["master_guest"]);}
				?>
				</td> 
