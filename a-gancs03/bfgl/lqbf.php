...
<table width="1000"   height="41" border="0" cellpadding="0" cellspacing="1"  bgcolor="006255" > 
  ...
  <?php 
	...
	while ($rows = $stmt->fetch()){
		...
		if ($bool){
			array_unshift($arr_bet, array( 0 => array($rows['Match_Name'], $rows['Match_Master'], $rows['Match_Guest']), 'Match_ID' => $rows['Match_ID'] ));
		}
	?> 	      
