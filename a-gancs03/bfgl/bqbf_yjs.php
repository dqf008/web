...
<table   border="0" cellspacing="1" cellpadding="0"  bgcolor="006255" width="900" height="41"> 
  ...
  <?php
	...
	$sql = 'SELECT Match_ID,Match_Time,Match_Master,Match_Guest,Match_Name,MB_Inball,TG_Inball,MB_Inball_HR,TG_Inball_HR FROM mydata4_db.baseball_match where match_js=1 and match_Date=:page_date order by Match_CoverDate,match_name,Match_Master desc';
