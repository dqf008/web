...
$sql = 'select Match_Date,Match_Time,match_name,Match_Master,Match_Guest, MB_Inball,TG_Inball,MB_Inball_HR,TG_Inball_HR from mydata4_db.bet_match where match_id=:match_id limit 1';
