...
$username = trim(trim($_GET['username'], ','));
$where = '';
$params = array();
if ($username == '')
{
...
$sql = 'SELECT uid,username,money,addtime,bid_gid FROM mydata3_db.save_user where addtime like(:addtime)' . $where . ' order by uid asc,id desc';
