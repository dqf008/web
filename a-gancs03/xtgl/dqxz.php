...
check_quanxian('xtgl');
if ($_GET['action'] == 'save'){
	$str = clear_html_code(rtrim($_POST['dq'], ','));
	if ($str){
		$dq = array();
		$dq = explode(',', $str);
		...
		if (!write_file('../../cache/dqxz.php', $str . '?>')){
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> 
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC"> 
    <tr> 
      <td height="24" nowrap background="../images/06.gif"><font style="float:left">&nbsp;<span class="STYLE2">地区/IP限制</span></font><font style="float:right">&nbsp;&nbsp;</font></td> 
    </tr> 
  </table> 
  <table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse;color: #225d9c;" id=editProduct   idth="100%" > 
	  <tr style="background-color: #EFE" class="t-title"  align="center"> 
          <td width="67%" height="20"><strong>被限制的地区名称/IP</strong></td> 
      </tr> 
    <tr align="center"> 
...
<?php }
	$i++;
?>
      <td width="33%" onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;">
		 <div style="float:left;"><?=$v;?></div>
		 <div style="float:right;padding-right:10px;"><a href="dqxz.php?action=del&id=<?=$k;?>" onclick="return confirm('确定解除地区/IP<?=$v;?>限制吗？')">解除</a></div>
	  </td>
	  <?php if ($i % 3 == 0){?> 
	 </tr>
<?php }
...
<?php }
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC"> 
    <tr> 
      <td height="24" nowrap background="../images/06.gif"><font style="float:left">&nbsp;<span class="STYLE2">添加限制地区/IP</span></font><font style="float:right">&nbsp;&nbsp;</font></td> 
    </tr> 
  </table> 
  <table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse;color: #225d9c;" id=editProduct   idth="100%" > 
  <form id="form1" name="form1" method="post" action="dqxz.php?action=save" onsubmit="return check();"> 
    <tr align="center"> 
      <td width="13%" align="right" >地区名称/IP：</td> 
