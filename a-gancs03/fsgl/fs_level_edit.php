...
if (isset($_REQUEST['save'])){
	...
	if (0 < $oid){
		...
		$params = array(':name' => $name, ':dml' => $dml, ':win' => $win, ':ty_rate' => $ty_rate, ':cp_rate' => $cp_rate, ':zr_rate' => $zr_rate, ':dz_rate' => $dz_rate, ':oid' => $oid);
		...
		$params = array(':name' => $name, ':dml' => $dml, ':win' => $win, ':ty_rate' => $ty_rate, ':cp_rate' => $cp_rate, ':zr_rate' => $zr_rate, ':dz_rate' => $dz_rate);
