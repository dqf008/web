...
while($rsq = $stmta->fetch()){
    ...
    if($myrow){
        ...
        $sqlMain='select * from lottery_k3_data where atype=:atype and mid=:qihao and bet_ok=0 order by ID asc';
...
function win_update($win, $id, $money, $username){
    ...
    $msql = 'update lottery_k3_data set win=:win,bet_ok=1 where id=:id';
