...
include_once ("../include/ffk3.func.php");
...
//$qishu = time()-60;
$qishu = time()+43200-60;
//$qishu = $qishu-fmod($qishu, 60);
$qishu = $qishu-fmod($qishu-14400, 60);
$params = array(':type' => 'FFK3', ':qishu' => $qishu);
...
if($stmt->rowCount()<=0){
	...
	$params[':value'] = array(
		'qishu' => date('Ymd', $qishu).substr('0000'.(floor(fmod($qishu-14400, 86400)/60)+1), -4),
//		'qishu' => date('Ymd', $qishu).substr('000'.(floor(fmod($qishu-14400, 86400)/180)+1), -3),
		'opencode' => $tempNum,
		'info' => array(),
	);
  ...
  <tr> 
	<td align="left" style="padding-left:10px; padding-top:10px; line-height:22px;">
	  <input type=button name=button value="刷新" onClick="window.location.reload()">
	   ...
	   <?php echo date('Ymd', $qishu).substr('0000'.(floor(fmod($qishu, 86400)/60)+1), -4); ?> 已开奖
<!--	   --><?php //echo date('Ymd', $qishu).substr('000'.(floor(fmod($qishu-14400, 86400)/180)+1), -4); ?><!-- 已开奖-->
	  </td>
  </tr>
</table>
</body>
