...
$qishu = time()+43200-90;
$qishu = $qishu-fmod($qishu-14400, 90);
$params = array(':type' => 'JSLH', ':qishu' => $qishu);
...
if($stmt->rowCount()<=0){
	...
	$params[':value'] = array(
		'qishu' => date('Ymd', $qishu).substr('000'.(floor(fmod($qishu-14400, 86400)/90)+1), -3),
		'opencode' => $tempNum,
	);
  ...
  <tr> 
	<td align="left" style="padding-left:10px; padding-top:10px; line-height:22px;">
	  <input type=button name=button value="刷新" onClick="window.location.reload()">
	   ...
	   <?php echo date('Ymd', $qishu).substr('000'.(floor(fmod($qishu-14400, 86400)/90)+1), -3); ?> 已开奖
	  </td>
  </tr>
</table>
</body>
