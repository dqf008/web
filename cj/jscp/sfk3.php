...
include_once ("../include/sfk3.func.php");
...
/* 两面长龙数据 结束 */
$qishu = time()+43200-180;
$qishu = $qishu-fmod($qishu-14400, 180);
//$qishu = $qishu-fmod($qishu-14400, 180);
$params = array(':type' => 'SFK3', ':qishu' => $qishu);
  ...
  <tr> 
	<td align="left" style="padding-left:10px; padding-top:10px; line-height:22px;">
	  <input type=button name=button value="刷新" onClick="window.location.reload()">
	   ...
	   <?php echo date('Ymd', $qishu).substr('000'.(floor(fmod($qishu-14400, 86400)/180)+1), -3); ?> 已开奖
<!--	   --><?php //echo date('Ymd', $qishu).substr('000'.(floor(fmod($qishu-14400, 86400)/180)+1), -3); ?><!-- 已开奖-->
	  </td>
  </tr>
</table>
