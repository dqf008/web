...
try
{
	...
	$sql = 'select MB_Inball,TG_Inball,MB_Inball_HR,TG_Inball_HR,Match_Master,match_name,Match_Guest,Match_ID from mydata4_db.baseball_match where (`Match_Date` =:Match_Date or `Match_Date` =:Match_Date1) and (MB_Inball>=0 or (MB_Inball=\'-1\' and TG_Inball=\'-1\')) and match_js!=\'1\' order by ID';
	...
	if (0 < count($mids)){
		...
		if ($bool){
			$mydata1_db->query('update mydata4_db.baseball_match set match_js=\'1\' where match_id in(' . $mid . ')');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left" style="padding-left:10px; padding-top:10px; line-height:22px;">
	   ...
	   采集网址：<?=$url?><br />
       <font color="#FF0000">接收<?=$m;?>条棒球结算！</font> <br />
      </td>
  </tr>
</table>
</body>
