...
<table width="100%" height="130" border="0">
  ...
  <tr>
    <td width="100%" align="center"><iframe src="auto_lq.php" name="autoFrame" id="autoFrame" title="autoFrame" frameborder=0 width="100%" scrolling=no height=260 ></iframe></td>
  </tr>
  <tr>
    <td width="100%" align="center"><iframe src="auto_cancel.php" name="autoFrame" id="autoFrame" title="autoFrame" frameborder=0 width="100%" scrolling=no height=260 ></iframe></td>
  </tr>
</table>
