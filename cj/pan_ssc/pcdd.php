...
$sql = 'select count(qihao) from lottery_k_pcdd where left(kaipan,10)=:l_date';
...
if(is_array($kl8) and $kl8){
  ...
  if ($cou == 0){
  	...
  	while ($row = $result->fetch()){
  		...
  		$sqlSub = 'insert into lottery_k_pcdd set qihao=:qihao,kaipan=:kaipan,fengpan=:fengpan,addtime=:addtime';
