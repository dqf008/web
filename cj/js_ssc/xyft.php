...
while ($rsq = $stmta->fetch()) {
	$qi = $rsq['qishu'];
	$para = array(':qishu'=>$qi);
	$sqlw = 'select * from c_auto_8 where qishu=:qishu limit 0,1';
	echo $qi;
