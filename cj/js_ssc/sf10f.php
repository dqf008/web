...
while($rsqs = $stmta->fetch()){
    ...
    $sqlw = 'select * from c_auto_3 where qishu=:qishu and name=:name limit 0,1';
    ...
    if($rs){
        ...
        $param = array(':qishu'=>$qi,':name'=>$name);
        $msql='update c_auto_3 set ok=1 where qishu=:qishu and name=:name';
