...
<TR vAlign=bottom class="tbtitle"> 
  ...
  <TD align=middle width="25%">开奖时间：<?=date("m-d-Y H:i:s",strtotime($Current_KitheTable['nd']));?></TD> 
  ...
  <TD align=right width="25%"><SPAN class=Font_B id=Update_Time></SPAN>&nbsp;<INPUT class="but_c1" style="LEFT: 0px;WIDTH: 64px;POSITION: relative;TOP: 0px;HEIGHT: 18px" onfocus=this.blur() onclick="beginrefresh();" type=button value=刷新赔率 name=LoadingPL>&nbsp;</TD></TR></TBODY></TABLE></td> 
</tr> 
	</table> 
...
<TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=258 border=0> 
	...
	style="HEIGHT: 18px"  class="input1" size="3" name="Num_50"  id="Num_50" /> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','dx',' 双 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
	style="HEIGHT: 18px"  class="input1" size="3" name="Num_51" id="Num_51" /> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','sb',' 红波 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
...
<TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=258 border=0> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','ds',' 大 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
	style="HEIGHT: 18px"  class="input1" size="3" name="Num_52" id="Num_52" /> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','ds',' 小 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
	style="HEIGHT: 18px"  class="input1" size="3" name="Num_53" id="Num_53" /> 
	  ...
	  <TR class=Ball_tr_H> 
		<TD class="Jut_caption_1 Font_B" style="color:#00F" width=78>蓝　波</TD> 
		<TD  width=77><b><span id=bl57>0</span></b></TD> 
		<TD  width=78  bgcolor="#FFFFFF"><input 
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','sb',' 蓝波 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
...
<TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=258 border=0> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			...
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','hd',' 合单 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
	style="HEIGHT: 18px"  class="input1" size="3" name="Num_54" id="Num_54" /> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			...
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','hd',' 合双 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
	style="HEIGHT: 18px"  class="input1" size="3" name="Num_55" id="Num_55" /> 
	  ...
	  <TR class=Ball_tr_H> 
		...
		<TD  width=78  bgcolor="#FFFFFF"><input 
			onKeyPress="return CheckKey();" 
					  onBlur="this.className='inp1';return CountGold(this,'blur','sb',' 绿波 ');" 
					  onKeyUp="return CountGold(this,'keyup');" 
					  onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
...
function ka_kk1($i){
	...
	global $ids;
	$params = array(':kithe' => $Current_Kithe_Num, ':username' => $_SESSION['kauser'], ':class1' => '正特', ':class2' => $ids, ':class3' => $i);
