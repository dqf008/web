...
<table width=98% border=0 align=center cellpadding=4 cellspacing=1 bordercolor=#cccccc bgcolor=#cccccc>          
	<tr>            
		<td height=28 align=center bgcolor=cb4619>
			<font color=ffff00>封盘中....<input class=button_a onClick="self.location='index.php?action=left'" type="button" value="离开" name="btnCancel" /></font>
		</td>          
	</tr>      
</table>
<?php exit();
              ...
              <TD class=Left_Place height=400 vAlign=top align=left> 
                  ...
                  <TABLE class=t_list cellSpacing=1 cellPadding=0 width=180 border=0> 
                      <tr class="left_acc_out_top"> 
                          <td height="30" align="center"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1"> 
                      <tr> 
                          <td height="25" colspan="4" align="center"  style="LINE-HEIGHT: 23px;color:#fff" bgcolor="#142F06">确认注单</td> 
                      </tr> 
                      <tr class="left_acc_out_top"> 
                          ...
                          <td align="center" class=left_acc_out_top style="LINE-HEIGHT: 23px">金额</td> 
                      </tr>
<?php 
$sum_sum = 0;
$j = 0;
...
for ($r = 1;$r <= $numm;$r++){
?>                        
 <input name="Num_<?=$r;?>" type="hidden" value="<?=abs($_POST['Num_'.$r]);?>" />
 <?php 
 if (abs($_POST['Num_' . $r]) != ''){
		...
		if (($ka_bl_row['class1'] == '特码') && ($r <= 49)){
			...
			if (($ka_bl_row['xr'] < ($sum_m55 + abs($_POST['Num_' . $r]))) || ($ka_bl_row['locked'] == 1)){
		...
		<tr <?php if ($j % 2 == 1){?> class=left_acc_inner<?php }else{?> class=left_acc_inner2<?php }?>  > 
          <td height="22"  class=left_acc_inner_con  style="LINE-HEIGHT: 23px"><font color="#FF0000"><?=$ka_bl_row['class2'];?>：<font color=ff6600><?=$ka_bl_row['class3'];?></font></font></td> 
...
?>          
                                  ...
                                  <td align="center"  class=left_acc_inner_con  style="LINE-HEIGHT: 23px"><?=abs($_POST['Num_'.$r]);?></td> 
                              </tr>
<?php }
}
