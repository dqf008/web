...
function SubChkBox(obj,bmbm) { 
  ...
  <TABLE  border="0" cellpadding="2" cellspacing="1" bordercolordark="#f9f9f9" bgcolor="#CCCCCC"width=780 > 
    ...
    <TR class="tbtitle"> 
      ...
      <TD align=right colSpan=3><?php if ($ids == '五不中')
{?> <input name="type0" type="radio" checked="checked" value="5" onClick="javascript:location.href='index.php?action=k_wbz&ids=五不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>五不中</span><?php }
else
{?> <input name="type0" type="radio" value="5" onClick="javascript:location.href='index.php?action=k_wbz&ids=五不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>五不中</span><?php }
if ($ids == '六不中')
{?> <input name="type0" type="radio" checked="checked" value="6" onClick="javascript:location.href='index.php?action=k_wbz&ids=六不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>六不中</span><?php }
else
{?> <input name="type0" type="radio" value="6" onClick="javascript:location.href='index.php?action=k_wbz&ids=六不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>六不中</span><?php }
if ($ids == '七不中')
{?> <input name="type0" type="radio" checked="checked" value="7" onClick="javascript:location.href='index.php?action=k_wbz&ids=七不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>七不中</span><?php }
else
{?> <input name="type0" type="radio" value="7" onClick="javascript:location.href='index.php?action=k_wbz&ids=七不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>七不中</span><?php }
if ($ids == '八不中')
{?> <input name="type0" type="radio" checked="checked" value="8" onClick="javascript:location.href='index.php?action=k_wbz&ids=八不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>八不中</span><?php }
else
{?> <input name="type0" type="radio" value="8" onClick="javascript:location.href='index.php?action=k_wbz&ids=八不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>八不中</span><?php }?> <br><?php if ($ids == '九不中')
{?> <input name="type0" type="radio" checked="checked" value="9" onClick="javascript:location.href='index.php?action=k_wbz&ids=九不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>九不中</span><?php }
else
{?> <input name="type0" type="radio" value="9" onClick="javascript:location.href='index.php?action=k_wbz&ids=九不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>九不中</span><?php }
if ($ids == '十不中')
{?> <input name="type0" type="radio" checked="checked" value="10" onClick="javascript:location.href='index.php?action=k_wbz&ids=十不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>十不中</span><?php }
else
{?> <input name="type0" type="radio" value="10" onClick="javascript:location.href='index.php?action=k_wbz&ids=十不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>十不中</span><?php }
if ($ids == '十一不中')
{?> <input name="type0" type="radio" checked="checked" value="10" onClick="javascript:location.href='index.php?action=k_wbz&ids=十一不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>十一不中</span><?php }
else
{?> <input name="type0" type="radio" value="10" onClick="javascript:location.href='index.php?action=k_wbz&ids=十一不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>十一不中</span><?php }
if ($ids == '十二不中')
{?> <input name="type0" type="radio" checked="checked" value="10" onClick="javascript:location.href='index.php?action=k_wbz&ids=十二不中';" ><SPAN id=rtm1 STYLE='color:ff0000;'>十二不中</span><?php }
else
{?> <input name="type0" type="radio" value="10" onClick="javascript:location.href='index.php?action=k_wbz&ids=十二不中';"><SPAN id=rtm1 STYLE='color:ffffff;'>十二不中</span><?php }?>
    ...
    <TR vAlign=bottom class="tbtitle"> 
      ...
      <TD align=right width="25%"><SPAN class=Font_B  id=Update_Time></SPAN></TD></TR></TBODY></TABLE></td> 
    </tr> 
        </table> 

  <form  method="post" onSubmit="return SubChk();"  action="index.php?action=k_wbzsave" name="lt_form" target="leftFrame" > 
  <TABLE cellSpacing=1 cellPadding=0 width=780 border=0 class="Ball_List" > 
                               <tr class="tbtitle"> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_r"><img src="images/num01.gif" /></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl40> 0 </span></b></td> 
                          ...
                          type=checkbox value=41 name=num41></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_r"><img src="images/num02.gif" width="27" height="27" /></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl41>0 </span></b></td> 
                          ...
                          type=checkbox value=42 name=num42></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_b"><span class="ball_r"><img src="images/num03.gif" width="27" height="27" /></span></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl42>0 </span></b></td> 
                          ...
                          type=checkbox value=43 name=num43></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_b"><span class="ball_r"><img src="images/num04.gif" width="27" height="27" /></span></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl43>0 </span></b></td> 
                          ...
                          type=checkbox value=44 name=num44></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_g"><span class="ball_r"><img src="images/num05.gif" width="27" height="27" /></span></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl44>0 </span></b></td> 
                          ...
                          type=checkbox value=45 name=num45></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_g"><span class="ball_r"><img src="images/num06.gif" width="27" height="27" /></span></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl45>0 </span></b></td> 
                          ...
                          type=checkbox value=46 name=num46></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_r"><img src="images/num07.gif" width="27" height="27" /></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl46>0 </span></b></td> 
                          ...
                          type=checkbox value=47 name=num47></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_r"><img src="images/num08.gif" width="27" height="27" /></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl47>0 </span></b></td> 
                          ...
                          type=checkbox value=48 name=num48></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_b"><span class="ball_r"><img src="images/num09.gif" width="27" height="27" /></span></td> 
        ...
        <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl48>0 </span></b></td> 
                          ...
                          type=checkbox value=49 name=num49></TD> 
                                  ...
                                  <TR> 
                                    <td align="center" bordercolordark="#f9f9f9" bgcolor="#FFFFFF" class="ball_b"><span class="ball_r"><img src="images/num10.gif" width="27" height="27" /></span></td> 
  ...
  金额: 
                                 <input  onKeyPress="return CheckKey();" onBlur="return CountGold(this,'blur','SP');"  onKeyUp="return CountGold(this,'keyup');" onFocus="CountGold(this,'focus');this.value='';"     style="HEIGHT: 18px" class="input1" name="jq" type="text" id="jq" size="5"> 
...
function Get_sx_nx($rrr){
	global $mydata2_db;
	$params = array(':id' => $rrr);
	$stmt = $mydata2_db->prepare('Select id,m_number,sx From ka_sxnumber where  id=:id Order By ID LIMIT 1');
	$stmt->execute($params);
