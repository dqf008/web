...
$XF = 19;
$ids = '过关';
$result = $mydata2_db->query('Select class3,rate,locked from ka_bl where class1=\'过关\' order by ID');
$drop_table = array();
$y = 0;
...
<?php if ($Current_KitheTable[29] == 0){?> 
<script language="javascript"> 
  Make_FlashPlay('imgs/T0.swf','T','780','500');
  </script><?php exit();
}
else if ($Current_KitheTable[19] == 0)
{?> <script language="javascript"> 
  ...
  <FORM name=lt_form_138 onSubmit="return SubChk(this);" action="index.php?action=k_ggsave" method="post" target="leftFrame"> 
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="780" style="margin-top:15px;"> 
      <tr> 
