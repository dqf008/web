...
{?> <script language="javascript"> 
  ...
  //} 
		...
		if (rtype=='dx' && (eval(eval(bb)+eval(goldvalue)) > <?=ka_memds(8,3)?>)) {gold.focus(); alert("对不起,止号本期下注金额最高限制 : <?=ka_memds(8,3)?>!!"); return false;}
  ...
  <TABLE  border="0" cellpadding="2" cellspacing="1" bordercolordark="#f9f9f9" bgcolor="#CCCCCC"width=780 > 
    ...
    <TR class="tbtitle"> 
      ...
      <button onClick="javascript:location.href='index.php?action=k_zm&ids=正A';"   class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color;?>;'>正码A</span></button>&nbsp;<button onClick="javascript:location.href='index.php?action=k_zm&ids=正B';"   class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color;?>;'>正码B</span></button> 
	  &nbsp;
  ...
  <TABLE cellSpacing=1 cellPadding=0 width=780 border=0 class="Ball_List" > 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 1 ','1');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 11 ','11');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 21 ','21');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 31 ','31');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 41 ','41');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 2 ','2');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 12 ','12');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 22 ','22');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 32 ','32');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 42 ','42');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 3 ','3');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 13 ','13');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 23 ','23');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 33 ','33');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 43 ','43');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 4 ','4');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 14 ','14');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onkeypress="return CheckKey();" 
                          onblur="return CountGold(this,'blur','SP',' 24 ','24');" 
                          onkeyup="return CountGold(this,'keyup');" 
                          onfocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 34 ','34');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 44 ','44');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 5 ','5');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 15 ','15');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 25 ','25');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 35 ','35');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 45 ','45');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 6 ','6');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 16 ','16');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 26 ','26');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 36 ','36');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 46 ','46');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 7 ','7');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 17 ','17');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 27 ','27');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 37 ','37');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 47 ','47');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 8 ','8');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 18 ','18');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 28 ','28');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 38 ','38');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 48 ','48');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 9 ','9');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 19 ','19');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 29 ','29');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 39 ','39');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 49 ','49');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
      ...
      <tr> 
        <td height="25" align="center" class="ball_b" bgcolor="#FFFFFF"><span class="ball_r"><img src="images/num10.gif" width="27" height="27" /></span></td> 
        <td height="25" align="center" valign="middle" bgcolor="#ffffff" class="ball_ff"><b><span id=bl9>0</span><span> </span></b></td> 
        <td height="25" align="center" bgcolor="#ffffff"><input onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 10 ','10');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input  onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 20 ','20');" 
                          onKeyUp="return CountGold(this,'keyup');" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 30 ','30');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        ...
        <td height="25" align="center" bgcolor="#ffffff"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','SP',' 40 ','40');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
  ...
  <tr> 
  <td> 
  <TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=388 border=0> 
          <TBODY> 
          <TR class=Ball_tr_H> 
            <TD class=Jut_caption_1 width=120>总和大</TD> 
            <TD  width=84><b><span id=bl51>0</span></b></TD> 
            <TD  width=140  bgcolor="#FFFFFF"><input 
			    onkeypress="return CheckKey();" 
                          onblur="return CountGold(this,'blur','ds',' 大 ');" 
                          onkeyup="return CountGold(this,'keyup');" 
                          onfocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        style="HEIGHT: 18px"  class="input1" size="3" name="Num_52" id="Num_52" /> 
          ...
          <TR class=Ball_tr_H> 
            <TD class=Jut_caption_1 width=120>总和小</TD> 
            <TD  width=84><b><span id=bl52>0</span></b></TD> 
            <TD  width=140  bgcolor="#FFFFFF"><input 
			    onkeypress="return CheckKey();" 
                          onblur="return CountGold(this,'blur','ds',' 小 ');" 
                          onkeyup="return CountGold(this,'keyup');" 
                          onfocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
  ...
  <TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=388 border=0> 
          <TBODY> 
          <TR class=Ball_tr_H > 
            <TD class=Jut_caption_1 width=120>总和单</TD> 
            <TD  width=84><b><span id=bl49>0</span></b></TD> 
            <TD  width=140  bgcolor="#FFFFFF"><input 
			    onKeyPress="return CheckKey();" 
                          onBlur="this.className='inp1';return CountGold(this,'blur','dx',' 单 ');" 
                          onKeyUp="return CountGold(this,'keyup');" 
                          onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
        style="HEIGHT: 18px"  class="input1" size="3" name="Num_50" id="Num_50" /> 
            <input name="gb50" type="hidden"  value="0"> 
            <input name="class3_50" value="单" type="hidden" ></TD></TR> 
          <TR class=Ball_tr_H> 
            <TD class=Jut_caption_1 width=120>总和双</TD> 
            <TD  width=84><b><span id=bl50>0</span></b></TD> 
            <TD  width=140  bgcolor="#FFFFFF"><input 
			    onkeypress="return CheckKey();" 
                          onblur="return CountGold(this,'blur','dx',' 双 ');" 
                          onkeyup="return CountGold(this,'keyup');" 
                          onfocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
...
switch ($bb)
{
  ...
  document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$bzm * 100;?>")/100;
  } 
  }else{ 
  if (num2!=num3){ 
  ...
  document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$bzmdx * 100;?>")/100;} 

  }<?php break;
	case 'C':?> if (i<=48){if (num2!=num3){ 
  ...
  document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$czm * 100;?>")/100;} 
  ...
  if (num2!=num3){ 
	  ...
	  }else{document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$czmdx * 100;?>")/100;} 
	  }<?php break;
	case 'D':?>
  ...
  document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$dzm * 100;?>")/100;
  } 
  }else{ 
  if (num2!=num3){ 
	  ...
	  }else{document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$dzmdx * 100;?>")/100;} 
	  }<?php break;
...
function ka_kk1($i){
	...
	global $ids;
	$params = array(':kithe' => $Current_Kithe_Num, ':username' => $_SESSION['kauser'], ':class1' => '正码', ':class2' => $ids, ':class3' => $i);
