...
?>
  ...
  function quick13()  // 家禽 =   xc5xa3xa1xa2xf1  R  xa1xa2xd1xf2xa1xa2xeb  u  xa1xa2xb9xb7xa1xa2xd8  i 
  { 
  for (var i=0;i<=11;i++) { 
  ...
  function quick14()  //   xd2xb0xab  F =   xcaxf3xa1xa2xbbxa2xa1xa2xcdxc3xa1xa2xfdx88xa1xa2xc9xdfxa1xa2xbaxef   
  { 
  for (var i=0;i<=11;i++) { 
  if ( i==0 || i==2 || i==4 || i==8 || i==1 || i==7 ){ 
...
<SCRIPT language=javascript> 
  ...
  <div align="right">
<?php if ($ids == '二肖'){?> 
  <button onClick="javascript:location.href='index.php?action=k_sx6&ids=二肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>二肖</span></button>&nbsp;
<?php }else{?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=二肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>二肖</span></button>&nbsp;
<?php }

if ($ids == '三肖'){
?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=三肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>三肖</span></button>&nbsp;
<?php 
}else{
?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=三肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>三肖</span></button>&nbsp;
<?php 
}
 
if ($ids == '四肖'){
?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=四肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>四肖</span></button>&nbsp;
<?php }
else
{?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=四肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>四肖</span></button>&nbsp;
<?php }
if ($ids == '五肖'){?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=五肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>五肖</span></button>&nbsp;
<?php }else{?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=五肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>五肖</span></button>&nbsp;
<?php 
}
if ($ids == '六肖'){?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=六肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>六肖</span></button>&nbsp;
<?php }else{?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=六肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>六肖</span></button>&nbsp;<?php }?> <hr style=" height:1px" />
<?php if ($ids == '七肖'){?> 
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=七肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>七肖</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=七肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>七肖</span></button>&nbsp;<?php }
 if ($ids == '八肖')
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=八肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>八肖</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=八肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>八肖</span></button>&nbsp;<?php }
 if ($ids == '九肖')
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=九肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>九肖</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=九肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>九肖</span></button>&nbsp;<?php }
 if ($ids == '十肖')
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=十肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>十肖</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=十肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>十肖</span></button>&nbsp;<?php }
 if ($ids == '十一肖')
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=十一肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>十一肖</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_sx6&ids=十一肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>十一肖</span></button>&nbsp;<?php }?>
  </div>    </TD></TR> 
  ...
  <form target="leftFrame" name="lt_form"  method="post"  onSubmit="return SubChk(this);" action="index.php?action=n2&class2=<?=$ids;?>"> 
  <TABLE cellSpacing=1 cellPadding=0 width=780 border=0 class="Ball_List" > 
	...
	<?php }?> 	  
	  ...
	  <td width="55" height="35" align="center" bgcolor="#FFFFFF" class="ball_ff"><B><span id="pfix<?=$I + 6;?>">0</span></B></td> 
        ...
        <td height="35" bgcolor="f1f1f1"  ><table align=left><tr>
<?php 
	$params = array(':sx' => $drop_table[$I + 6][0]);
	$stmt = $mydata2_db->prepare('Select m_number from ka_sxnumber where sx=:sx order by id');
	$stmt->execute($params);
	$image = $stmt->fetch();
	$xxm = explode(',', $image['m_number']);
	...
	for ($j = 0;$j < $ssc;$j = $j + 1){
?>     
	 <td align=middle   height="32" width="32" class="ball_<?=Get_bs_Color(intval($xxm[$j]))?>"><img src="images/num<?=$xxm[$j]?>.gif" />  
<?php }?> 	  
</tr>
</table>  	  
</td> 
	...
	<tr> 
	    <td height="35" colspan="8" align="center"  bgcolor="#FFFFFF"><table border="0" align="center" cellpadding="0" cellspacing="0"> 
          <tr> 
			...
			<input name="Num_1"  class="input1" id="Num_1" style="HEIGHT: 18px"  onfocus="CountGold(this,'focus');this.value='';" onblur="return CountGold(this,'blur','SP','<?=ka_kk1("六肖")?>');" onkeypress="return CheckKey();"  onkeyup="return CountGold(this,'keyup');" size="8" /></td> 
            <td width="188" align="left">&nbsp;&nbsp;&nbsp;<input name="btnSubmit"    type="submit"  class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'" id="btnSubmit" value="提交" />&nbsp;&nbsp;
            ...
            <td>&nbsp;
<?php if ($ids == '六肖'){?> 
<INPUT   class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'" name="button2" type=button onclick=quick13() value=家禽>&nbsp;
  <INPUT  class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'"  name="button2" type=button onclick=quick14() value=野兽><?php }?>  &nbsp;<INPUT   class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'" name="button2" type=button onclick=turn() value=反选> 
  </td>        </tr> 
        </table></td> 
...
function ka_kk1($i){
	...
	global $ids;
	$params = array(':kithe' => $Current_Kithe_Num, ':username' => $_SESSION['kauser'], ':class1' => '生肖', ':class2' => $ids);
