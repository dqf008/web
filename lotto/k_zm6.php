...
<script language="javascript"> 
  Make_FlashPlay('imgs/T0.swf','T','700','500');
  </script><?php exit();
}
$result = $mydata2_db->query('Select class3,rate,class2  from ka_bl where class1=\'正1-6\'   Order By class2,ID');
$drop_table = array();
$y = 0;
...
<form target="leftFrame" name="lt_form"  method="post" action="index.php?action=n1&class2=正1-6"> 
...
<tr> 
  ...
  <td> 
<table width="110" border="0" cellpadding="0" cellspacing="1" class="Ball_List"> 
	<tr><td colspan="2" class="td_caption_1">正码一</td></tr> 
	<tr> 
	  <td width="48" class="td_caption_1">赔率</td> 
...
<input name="class3_3" value="单" type="hidden" ><input name="class2_3" value="正码1" type="hidden" ></td> 
   ...
   <tr class="Ball_tr_H"> 
	  <td ID="jeu_p_13_249"><span id=bl3>0</span></td> 
	  <td ID="jeu_m_13_249" bgcolor="#F7F0FB"><input 
onKeyPress="return CheckKey();" 
onBlur="this.className='inp1';return CountGold(this,'blur','dx','');" 
onKeyUp="return CountGold(this,'keyup');" 
onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
...
onKeyUp="return CountGold(this,'keyup');" 
onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" name="Num_48" /> 
<input name="class3_48" value="合小" type="hidden" ><input name="class2_48" value="正码4" type="hidden" ></td> 
	</tr> 
   <tr class="Ball_tr_H"> 
	  <td ID="jeu_p_15_276"><span id=bl48>0</span></td> 
	  <td ID="jeu_m_15_276" bgcolor="#F7F0FB"><input 
onKeyPress="return CheckKey();" 
onBlur="this.className='inp1';return CountGold(this,'blur','','');" 
onKeyUp="return CountGold(this,'keyup');" 
onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" name="Num_49" /> 
<input name="class3_49" value="合单" type="hidden" ><input name="class2_49" value="正码4" type="hidden" ></td> 
	</tr> 
	<tr class="Ball_tr_H"> 
	  <td ID="jeu_p_15_282"><span id=bl49>0</span></td> 
	  <td ID="jeu_m_15_282" bgcolor="#F7F0FB"><input 
onKeyPress="return CheckKey();" 
onBlur="this.className='inp1';return CountGold(this,'blur','','');" 
onKeyUp="return CountGold(this,'keyup');" 
...
<input name="class3_65" value="尾小" type="hidden" ><input name="class2_65" value="正码5" type="hidden" ></td> 
  ...
  <table width="110" border="0" cellpadding="0" cellspacing="1" class="Ball_List"> 
	...
	<tr class="Ball_tr_H"> 
	  <td ID="jeu_p_13_248"><span id=bl67>0</span></td> 
	  <td ID="jeu_m_13_248" bgcolor="#F7F0FB"><input 
onKeyPress="return CheckKey();" 
onBlur="this.className='inp1';return CountGold(this,'blur','dx','');" 
onKeyUp="return CountGold(this,'keyup');" 
onFocus="this.className='inp1m';CountGold(this,'focus');this.value='';" 
...
document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$bztdx * 100;?>")/100;}<?php break;
case 'C':?>
if (num2!=num3){ 
...
document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$cztdx * 100;?>")/100;}<?php break;
case 'D':?>
...
document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$dztdx * 100;?>")/100;}<?php break;
...
function ka_kk1($i, $bbs){
	...
	$params = array(':kithe' => $Current_Kithe_Num, ':username' => $_SESSION['kauser'], ':class1' => '正码', ':class2' => $bbs, ':class3' => $i);
