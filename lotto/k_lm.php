...
$result = $mydata2_db->query('Select class3,rate from ka_bl where class1=\'连码\' order by ID');
$drop_table = array();
$y = 0;
while ($image = $result->fetch())
{
  ...
  <form  method="post" onSubmit="return SubChk();"  action="index.php?action=k_lmsave" name="lt_form" target="leftFrame"> 
  <table  width="780" border=0 cellPadding=2 cellSpacing=1 bgcolor="#cccccc"> 
            ...
            <TABLE width="780"  border=0 cellPadding=0 cellSpacing=1  class="Ball_List"> 
              <TBODY> 
                                    ...
                                    <tbody> 
                                      <tr align="middle"> 
                                        <td align="center" class="Jut_caption_1"> 
                                           鼠 
                                          <input name="pan1 1 " type="radio" onClick="r_pan1( 1 );javascript:ra_select('pan1',' 1 ')" value=" 1 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">牛 
                                          <input name="pan1 7 " type="radio" onClick="r_pan1( 7 );javascript:ra_select('pan1',' 7 ')"  value=" 7 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">虎 
                                          <input name="pan1 2 " type="radio" onClick="r_pan1( 2 );javascript:ra_select('pan1',' 2 ')" value=" 2 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">兔 
                                          <input name="pan1 8 " type="radio" onClick="r_pan1( 8 );javascript:ra_select('pan1',' 8 ')"   value=" 8 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">龙 
                                          <input name="pan1 3 " type="radio"  onclick="r_pan1( 3 );javascript:ra_select('pan1',' 3 ')" value=" 3 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">蛇 
                                          <input name="pan1 9 " type="radio"  onclick="r_pan1( 9 );javascript:ra_select('pan1',' 9 ')"  value=" 9 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">马 
                                          <input name="pan1 4 " type="radio"  onclick="r_pan1( 4 );javascript:ra_select('pan1',' 4 ')"  value=" 4 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">羊 
                                          <input name="pan1 10 " type="radio" onClick="r_pan1( 10 );javascript:ra_select('pan1',' 10 ')"  value=" 10 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">猴 
                                          <input name="pan1 5 " type="radio" onClick="r_pan1( 5 );javascript:ra_select('pan1',' 5 ')"  value=" 5 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">鸡 
                                          <input name="pan1 11 " type="radio" onClick="r_pan1( 11 );javascript:ra_select('pan1',' 11 ')"  value=" 11 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">狗 
                                          <input name="pan1 6 " type="radio" onClick="r_pan1( 6 );javascript:ra_select('pan1',' 6 ')"  value=" 6 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">猪 
                                        <input name="pan1 12 " type="radio"  onclick="r_pan1( 12 );javascript:ra_select('pan1',' 12 ')" value=" 12 " /> 
                                      ...
                                      <tr align="middle"> 
                                        <td align="center" class="Jut_caption_1"><input name="pan2" type="hidden" value=""> 
                                          鼠 
                                          <input name="pan2 1 " type="radio" onClick="r_pan2( 1 );javascript:ra_select('pan2',' 1 ')" value=" 1 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">牛 
                                          <input name="pan2 7 " type="radio" onClick="r_pan2( 7 );javascript:ra_select('pan2',' 7 ')"  value=" 7 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">虎 
                                          <input name="pan2 2 " type="radio" onClick="r_pan2( 2 );javascript:ra_select('pan2',' 2 ')" value=" 2 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">兔 
                                          <input name="pan2 8 " type="radio" onClick="r_pan2( 8 );javascript:ra_select('pan2',' 8 ')"   value=" 8 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">龙 
                                          <input name="pan2 3 " type="radio"  onclick="r_pan2( 3 );javascript:ra_select('pan2',' 3 ')" value=" 3 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">蛇 
                                          <input name="pan2 9 " type="radio"  onclick="r_pan2( 9 );javascript:ra_select('pan2',' 9 ')"  value=" 9 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">马 
                                          <input name="pan2 4 " type="radio"  onclick="r_pan2( 4 );javascript:ra_select('pan2',' 4 ')"  value=" 4 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">羊 
                                          <input name="pan2 10 " type="radio" onClick="r_pan2( 10 );javascript:ra_select('pan2',' 10 ')"  value=" 10 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">猴 
                                          <input name="pan2 5 " type="radio" onClick="r_pan2( 5 );javascript:ra_select('pan2',' 5 ')"  value=" 5 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">鸡 
                                          <input name="pan2 11 " type="radio" onClick="r_pan2( 11 );javascript:ra_select('pan2',' 11 ')"  value=" 11 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">狗 
                                          <input name="pan2 6 " type="radio" onClick="r_pan2( 6 );javascript:ra_select('pan2',' 6 ')"  value=" 6 " /> 
                                        </td> 
                                        <td align="center"class="Jut_caption_1">猪 
                                        <input name="pan2 12 " type="radio"  onclick="r_pan2( 12 );javascript:ra_select('pan2',' 12 ')" value=" 12 " /></td> 
                                      </tr> 
                                    </tbody> 
                                  </table> 
                              </div> 
