...
while ($image = $stmt->fetch())
{
  ...
  <TABLE  border="0" cellpadding="2" cellspacing="1" bordercolordark="#f9f9f9" bgcolor="#CCCCCC"width=780 > 
   ...
   <div align="right"><?php if ($ids == '二尾连中')
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=二尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>二尾连中</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=二尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>二尾连中</span></button>&nbsp;<?php }
 if ($ids == '三尾连中')
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=三尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>三尾连中</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=三尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>三尾连中</span></button>&nbsp;<?php }
 if ($ids == '四尾连中')
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=四尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>四尾连中</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=四尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>四尾连中</span></button>&nbsp;<?php }?>  <br><hr  style="height:1px;"/><?php if ($ids == '二尾连不中')
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=二尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>二尾连不中</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=二尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>二尾连不中</span></button>&nbsp;<?php }
 if ($ids == '三尾连不中')
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=三尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>三尾连不中</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=三尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>三尾连不中</span></button>&nbsp;<?php }
 if ($ids == '四尾连不中')
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=四尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>四尾连不中</span></button>&nbsp;<?php }
else
{?> <button onClick="javascript:location.href='index.php?action=k_wsl&ids=四尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>四尾连不中</span></button>&nbsp;<?php }?>
             </div> 
      </TD></TR> 
   ...
   <form target="leftFrame" name="lt_form"  method="post" action="index.php?action=k_wslsave&class2=<?=$ids;?>"> 
...
<?php 
	...
	<?php }?> 	  </tr></table>  	  </td> 
	  ...
	  <td width="41" height="35" align="center"  class="Jut_caption_1"><span class="STYLE4"><?=$drop_table[$I + 5][0];?></span></td> 
        ...
        <td height="25" bgcolor="f1f1f1"  ><table align=left><tr>
	<?php 
	$params = array(':sx' => $drop_table[$I + 5][0]);
	$stmt = $mydata2_db->prepare('Select m_number from ka_sxnumber where sx=:sx order by id');
	$stmt->execute($params);
	$image = $stmt->fetch();
	$xxm = explode(',', $image['m_number']);
...
function ka_kk1($i){
	...
	global $ids;
	$params = array(':kithe' => $Current_Kithe_Num, ':username' => $_SESSION['kauser'], ':class1' => '尾数连', ':class2' => $ids, ':class3' => $i);
