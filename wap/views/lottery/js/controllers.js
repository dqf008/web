...
.controller('LotteryCtrl', function($scope, $timeout, $log, $filter, $stateParams, $ionicPopover, $location, $interpolate, $ionicScrollDelegate, $document, $state, Tools, My, PATH) {
	var curName = angular.copy($state.current.name);
