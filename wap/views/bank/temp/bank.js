...
// .controller('WithdrawController', function($scope, $log, $state, $filter, My, Tools, md5) {
...
// 					}else{
// 						$scope.bankData = data;
// 						$scope.withdrawStep = data.msg&&data.msg.length>0?5:4;
// 					}
// 				}
// 			});
// 		}
...
// 			scope: $scope,
// 			title: '收款银行地址',
// 			template: $scope.bankData.list[index].address
// 		});
// 	};
// 	$scope.withdrawSubmit = function() {
// 		var amount = $scope.withdrawData.applyMoney;
...
.controller('DepositController', function($scope, $log, $state, $filter, ENV, Tools, BankService) {
...
.controller('OnlinePayController', function($scope, $log, $state, $cookies, $filter, ENV, Tools, BankService) {
...
.controller('OfflinePayController', function($scope, $log, $state, $filter, ENV, Tools, BankService) {
	var rechType = $state.current.data.rechType;
