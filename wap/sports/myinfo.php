...
<div data-role="popup" id="popupPanel" data-corners="true" data-theme="b" data-shadow="true" class="ui-popup ui-body-b ui-overlay-shadow ui-corner-all" style="position: fixed;top:20px;left:20px;"> 
  <div style="margin:5px 2px 5px 2px;padding:1px 1px 1px 1px;"> 
	  <ul data-role="listview" class="ui-listview"> 
		  ...
		  <li> 
			  <a href="javascript:window.location.href='../#/bank/transfer'" class="ui-btn ui-btn-icon-right ui-icon-carat-r"> 
			  汇款提交 
			  </a> 
		  </li> 
		  <li> 
			  <a href="javascript:window.location.href='../#/ucenter/transfer'" class="ui-btn ui-btn-icon-right ui-icon-carat-r"> 
			  额度转换 
			  </a> 
		  </li> 
		  <!-- <li> 
		  ...
		  <li> 
			  <a href="javascript:window.location.href='../#/report/index?type=Sports'" class="ui-btn ui-btn-icon-right ui-icon-carat-r"> 
			  下注记录 
			  </a> 
		  </li> 
		  <li> 
			  <a href="javascript:window.location.href='../#/bank/money?type=trans'" class="ui-btn ui-btn-icon-right ui-icon-carat-r"> 
			  财务记录 
			  </a> 
		  </li> 
